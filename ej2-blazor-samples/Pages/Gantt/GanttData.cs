...
namespace ej2_blazor_ganttdata
{
    public class GanttData
    {
        ...
        public static List<TaskbarData> TaskbarTemplateData()
        {
            ...
            TaskbarData Record1 = new TaskbarData()
            {
                TaskId = 1,
                TaskName = "90th Academy awards kicks-off",
                StartDate = new DateTime(2015, 03, 05, 18, 0, 0),
                EndDate = new DateTime(2015, 03, 05, 18, 0, 0),
                Duration = 0
            };
            TaskbarData Record2 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 18, 0, 0),
                EndDate = new DateTime(2015, 03, 05, 18, 15, 0),
                Predecessor = "1",
                Winner = "",
            ...
            TaskbarData Record3 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 18, 16, 0),
                EndDate = new DateTime(2015, 03, 05, 18, 25, 0),
                Predecessor = "2",
                Winner = "Sam Rockwell",
            ...
            TaskbarData Record4 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 18, 26, 0),
                EndDate = new DateTime(2015, 03, 05, 18, 32, 0),
                Predecessor = "3",
                Movie = "Darkest Hour"
            };
            TaskbarData Record5 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 18, 33, 0),
                EndDate = new DateTime(2015, 03, 05, 18, 40, 0),
                Predecessor = "4",
                Winner = "Mark Bridges",
            ...
            TaskbarData Record6 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 18, 41, 0),
                EndDate = new DateTime(2015, 03, 05, 18, 58, 0),
                Predecessor = "5",
                Winner = "Bryan Fogel",
                Movie = "Icarus"
            };
            TaskbarData Record7 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 18, 59, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 10, 0),
                Predecessor = "6",
            ...
            TaskbarData Record8 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 11, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 15, 0),
                Predecessor = "7",
            ...
            TaskbarData Record9 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 16, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 23, 0),
                Predecessor = "8",
            ...
            TaskbarData Record10 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 24, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 29, 0),
                Predecessor = "9",
            ...
            TaskbarData Record11 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 30, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 35, 0),
                Predecessor = "10",
            ...
            TaskbarData Record12 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 36, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 45, 0),
                Predecessor = "11",
                Winner = "Kobe Bryant",
            ...
            TaskbarData Record13 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 46, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 52, 0),
                Predecessor = "12",
                Movie = "Coco"
            };
            TaskbarData Record14 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 53, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 56, 0),
                Predecessor = "13",
            ...
            TaskbarData Record15 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 19, 57, 0),
                EndDate = new DateTime(2015, 03, 05, 19, 59, 0),
                Predecessor = "14",
                Movie = "Dunkirk",
            };
            TaskbarData Record16 = new TaskbarData()
            {
                TaskId = 16,
                TaskName = "Oscar moments",
                StartDate = new DateTime(2015, 03, 05, 20, 0, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 09, 0),
                Predecessor = "15",
            ...
            TaskbarData Record17 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 20, 10, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 12, 0),
                Predecessor = "16",
            ...
            TaskbarData Record18 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 20, 13, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 15, 0),
                Predecessor = "17",
            ...
            TaskbarData Record20 = new TaskbarData()
            {
                TaskId = 20,
                TaskName = "Oscar moments",
                StartDate = new DateTime(2015, 03, 05, 20, 26, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 29, 0),
                Predecessor = "19",
            ...
            TaskbarData Record21 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 20, 30, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 35, 0),
                Predecessor = "20",
                Winner = "James Ivory",
            ...
            TaskbarData Record22 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 20, 36, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 44, 0),
                Predecessor = "21",
                Winner = "Jordan Peele",
                Movie = "Get Out"
            };
            TaskbarData Record23 = new TaskbarData()
            {
                TaskId = 23,
                TaskName = "Oscar moments",
                StartDate = new DateTime(2015, 03, 05, 20, 40, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 45, 0),
                Predecessor = "22",
            ...
            TaskbarData Record24 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 20, 46, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 48, 0),
                Predecessor = "23",
            ...
            TaskbarData Record25 = new TaskbarData()
            {
                TaskId = 25,
                TaskName = "Oscar performance",
                StartDate = new DateTime(2015, 03, 05, 20, 49, 0),
                EndDate = new DateTime(2015, 03, 05, 20, 54, 0),
                Predecessor = "24",
            ...
            TaskbarData Record27 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 21, 0, 0),
                EndDate = new DateTime(2015, 03, 05, 21, 07, 0),
                Predecessor = "26",
                Winner = "Remember Me",
                Movie = "Coco"
            };
            TaskbarData Record28 = new TaskbarData()
            {
                TaskId = 28,
                TaskName = "Oscar moments",
                StartDate = new DateTime(2015, 03, 05, 21, 05, 0),
                EndDate = new DateTime(2015, 03, 05, 21, 11, 0),
                Predecessor = "27",
            ...
            TaskbarData Record29 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 21, 12, 0),
                EndDate = new DateTime(2015, 03, 05, 21, 19, 0),
                Predecessor = "28",
            ...
            TaskbarData Record30 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 21, 20, 0),
                EndDate = new DateTime(2015, 03, 05, 21, 29, 0),
                Predecessor = "29",
                Winner = "Gary Oldman",
                Movie = "The Shape of Water"
            };
            TaskbarData Record31 = new TaskbarData()
            {
                ...
                StartDate = new DateTime(2015, 03, 05, 21, 30, 0),
                EndDate = new DateTime(2015, 03, 05, 21, 44, 0),
                Predecessor = "30",
