...
if %errorlevel% equ 0 (
    echo.
    echo RichTextEditor category filter applied successfully!
    echo Included components: RichTextEditor, BlockEditor, MarkdownEditor
    exit /b 0
) else (
