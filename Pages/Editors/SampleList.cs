    ...
    internal partial class SampleConfig
    {
        public List<Sample> InPlaceEditor { get; set; } = new List<Sample>{
            new Sample
            {
                ...
                <p>
                    More information on the <code>In-place Editor</code> instantiation can be found in the<a target=""_blank"" href=""https://blazor.syncfusion.com/documentation/in-place-editor/getting-started/""> documentation section </a>.
                </p>"
                }
            },
            new Sample
