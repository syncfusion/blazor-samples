        ...
        public static List<string> GetDynamicResources(NavigationManager uriHelper, SampleService sampleService)
        {
            ...
            else if (!sampleService.IsDemoLoaded)
            {
                ...
                resourceList = new List<string>
                {
                    ...
                    $"{sampleService.WebAssetsPath}scripts/common/highlight.min.js"
                };
                ...
                resourceList = new List<string>
                {
                    ...
                    $"{sampleService.WebAssetsPath}scripts/common/demos.min.js"
                };
...
#if DEBUG || STAGING
                    resourceList.Add($"{sampleService.WebAssetsPath}scripts/diagram/interop.js");
#else
                    resourceList.Add($"{sampleService.WebAssetsPath}scripts/diagram/interop.min.js");
#endif
                }
            }
            return resourceList;
