...
namespace BlazorDemos.Shared
{
    ...
    public class DynamicResourceLoader : ComponentBase
    {
        ...
        private readonly Dictionary<string, ComponentSamplesResources> CompSamplesResourcesMappings =
            new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "ai-diagram", new() { CssDirectory = "ai-diagram", JsFiles = new[] { "sf-diagramcomponent", "sf-contextmenu", "sf-toolbar", "sf-dropdownlist", "sf-floating-action-button", "sf-spinner", "sf-dialog", "sf-drop-down-button", "sf-uploader", "sf-numerictextbox", "sf-textbox", "sf-toast" } } },
            { "ai-kanban", new() { CssDirectory = "ai-kanban", JsFiles = new[] { "sf-kanban", "sf-toast" } } },
            { "ai-assist-view", new() { CssDirectory = "ai-assistview", JsFiles = new[] { "sf-ai-assistview", "sf-textarea", "sf-drop-down-button", "sf-splitter", "sf-floating-action-button", "sf-sidebar", "sf-toolbar", "sf-listview", "sf-toast", "sf-dropdownlist", "sf-switch" } } },
            ...
            { "chart-wizard", new() { CssDirectory = "chartwizard", JsFiles = new[] { "sf-chart-wizard", "sf-uploader", "sf-toolbar", "sf-contextmenu", "sf-sidebar", "sf-tab", "sf-accordion", "sf-grid", "sf-dropdownlist", "sf-textbox", "sf-colorpicker", "sf-numerictextbox", "sf-dialog", "sf-checkbox", "sf-menu" } } },
            ...
            { "diagram", new() { CssDirectory = "diagram", JsFiles = new[] { "sf-diagramcomponent", "sf-uploader", "sf-numerictextbox", "sf-colorpicker", "sf-textbox", "sf-drop-down-button", "sf-toolbar", "sf-tab", "sf-treeview", "sf-grid", "sf-daterangepicker", "sf-chart", "sf-accumulation-chart", "sf-dropdownlist", "sf-dialog", "sf-textarea", "sf-lineargauge", "sf-toast", "sf-circulargauge", "sf-checkbox", "sf-switch", "sf-floating-action-button", "sf-contextmenu", "sf-tooltip" } } },
            ...
            { "ai-smart-rich-text-editor", new() { CssDirectory = "rich-text-editor", JsFiles = new[] { "sf-smartrichtexteditor", "sf-richtexteditor", "sf-checkbox", "sf-dropdownlist", "sf-mention", "sf-chat-ui", "sf-toast", "sf-dialog", "sf-drop-down-button", "sf-ai-assistview", "sf-menu" } } },
            { "markdown-editor", new() { CssDirectory = "markdown-editor", JsFiles = new[] { "sf-richtexteditor", "sf-mention", "sf-splitter" } } },
            ...
            { "scheduler", new() { CssDirectory = "schedule", JsFiles = new[] { "sf-schedule", "sf-uploader", "sf-drop-down-button", "sf-toolbar", "sf-contextmenu", "sf-multiselect", "sf-dropdownlist", "sf-timepicker", "sf-sidebar", "sf-grid", "sf-pager", "sf-calendar", "sf-listview", "sf-dialog", "sf-textbox", "sf-toast", "sf-treeview", "sf-colorpicker", "sf-tab", "sf-spinner", "sf-checkbox", "sf-chart" } } },
            ...
            { "ai-assistview", new() { CssDirectory = "ai-assistview", JsFiles = new[] { "sf-ai-assistview", "sf-textarea", "sf-carousel", "sf-drop-down-button", "sf-splitter", "sf-dialog", "sf-floating-action-button", "sf-sidebar", "sf-toolbar", "sf-listview", "sf-speechtotext", "sf-toast", "sf-dropdownlist", "sf-switch" } } },
            ...
            { "inline-ai-assist", new() { CssDirectory = "inline-ai-assist", JsFiles = new[] { "sf-inline-ai-assist", "sf-textarea", "sf-drop-down-button", "sf-splitter", "sf-floating-action-button", "sf-mention", "sf-toolbar", "sf-toast", "sf-dialog", "sf-dropdownlist" } } },
            ...
            { "query-builder", new() { CssDirectory = "query-builder", JsFiles = new[] { "sf-querybuilder", "sf-grid", "sf-toast", "sf-checkbox", "sf-dropdownlist", "sf-dialog", "sf-textbox", "sf-tooltip", "sf-tab", "sf-slider", "sf-drop-down-button", "sf-daterangepicker" } } },
        ...
        private readonly Dictionary<string, string> StaticAssetScriptPathMappings = new()
        {
            ...
            { "sf-inline-ai-assist", "interactivechat"},
            ...
            { "sf-smartrichtexteditor", "smartrichtexteditor" },
            { "sf-sankey", "sankey" },
        ...
        private string GetResourcesMarkup()
        {
            ...
            var theme = uri != null? SampleUtils.GetThemeName(uri): string.Empty;
        ...
        var minExtension = "";
            ...
            var isErrorPage = string.Equals(UriHelper?.Uri, UriHelper?.BaseUri + "error", StringComparison.Ordinal);
            if (UriHelper is not null && SampleUtils.IsHomePage(UriHelper))
            {
#if !STAGING && RELEASE
            ...
            {
                if(!isOldTheme && (SampleService == null || !SampleService.IsBuild))
                {
                    sb.AppendLine(CultureInfo.InvariantCulture,$"<link rel=\"stylesheet\" href=\"{stylePath}demo-page-comps/{theme}.min.css\" onload=\"onCommonLayoutStylesLoaded('{theme}')\"/>");
                }
                // Get the current component page details
                var compKey = GetComponentKey();
                // Retrieve the two values (e.g., CssDirectory and JsFiles) based on compName
                ComponentSamplesResources resources = (compKey != null && CompSamplesResourcesMappings !=null ) ? CompSamplesResourcesMappings.GetValueOrDefault(compKey) ?? new ComponentSamplesResources(): new ComponentSamplesResources();
                ...
                resources.JsFiles = resources.JsFiles?.Except(demoPageCompsScript).ToArray();
                if (SampleService?.SampleName == null)
                {
                    if (!string.IsNullOrEmpty(resources.CssDirectory) && !isOldTheme && (SampleService == null || !SampleService.IsBuild))
                    {   
                        if (resources.CssDirectory == "overall")
                        {
                            sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{overallStylePath}{theme}.css\" />");
                        }
                        else
                        {
                            sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{stylePath}{resources.CssDirectory}/{theme}.min.css\" />");
                        }
                    }
                ...
                else
                {
                    if (!string.IsNullOrEmpty(resources.CssDirectory) && !isOldTheme && !SampleService.IsBuild)
                    {
                        ...
                        {
                            sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{stylePath}{resources.CssDirectory}/{theme}.min.css\" onload=\"onCompStylesLoaded(false)\" />");
                        }
                        else
                        {
                            sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{stylePath}{resources.CssDirectory}/{theme}.min.css\" onload=\"onCompStylesLoaded(true)\" />");
                        }
                    }
                    if (resources.JsFiles != null)
                    {
                ...
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}image-editor{minExtension}.js\"></script>");
                }
                if (compKey == "ribbon")
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}ribbon{minExtension}.js\"></script>");
                }
                if (compKey == "rich-text-editor")
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}richtexteditor{minExtension}.js\"></script>");
                }
                if (compKey == "speech-to-text" || compKey == "ai-assistview")
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}speechtotext{minExtension}.js\"></script>");
                }
                if (compKey == "ai-assistview")
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}texttospeech{minExtension}.js\"></script>");
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}ai-assistview{minExtension}.js\"></script>");
                }
                if (compKey == "inline-ai-assist")
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<script src=\"{sbSamplesJsPath}inlineaiassist{minExtension}.js\"></script>");
                }
                if (compKey == "diagram" || compKey == "ai-diagram")
                {
                    sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{sbDiagramCssPath}diagram/syncfusion-blazor-icons{minExtension}.css\" />");
                }
                if (!string.IsNullOrEmpty(theme))
                {
                    if (theme.Contains("dark", StringComparison.Ordinal) || theme.Contains("fluent2-highcontrast", StringComparison.Ordinal) || theme.Contains("highcontrast", StringComparison.Ordinal))
                    {
                        sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{sbCommonCssPath}common/highcontrast{minExtension}.css\" />");
                        sb.AppendLine(CultureInfo.InvariantCulture, $"<link rel=\"stylesheet\" href=\"{sbCommonCssPath}common/dark-theme{minExtension}.css\" />");
                }
                }
        ...
        private string? GetComponentKey()
        {
            ...
            if (SampleService?.SampleName == null) {
                demoPath = SampleService?.SampleInfo?.Url ?? string.Empty;
            }
            else
            {
            ...
            {
                if (demoPath?.Contains($"buttons/{component}", StringComparison.Ordinal) == true)
                {
                    return component;
                }
            }
