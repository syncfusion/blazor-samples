...
namespace BlazorDemos
{
...
#if WASM
    #if NET6_0
            "_content/BlazorWasmCommon_NET6/styles/common/fonts/open-sans-700.woff2",
            "_content/BlazorWasmCommon_NET6/styles/common/fonts/open-sans-regular.woff2"
    #else
            "_content/BlazorWasmCommon_NET7/styles/common/fonts/open-sans-700.woff2",
            "_content/BlazorWasmCommon_NET7/styles/common/fonts/open-sans-regular.woff2"
    #endif  
#else
    #if NET6_0
    ...
    #else
            "_content/BlazorServerCommon_NET7/styles/common/fonts/open-sans-700.woff2",
            "_content/BlazorServerCommon_NET7/styles/common/fonts/open-sans-regular.woff2",
    #endif
#endif
        };
    }
