    ...
    internal partial class SampleConfig
    {
        public List<Sample> PivotTable { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @"The sample has been updated to show the UI support for Grand totals position that has been added to the built-in toolbar option's drop-down menu." }
            },
            new Sample
            {
                Name = "Pivot Chart",
