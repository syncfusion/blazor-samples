...
namespace BlazorDemos.Pages.GanttChart
{
    public partial class ExcelFiltering
    {
        ...
        public List<FilterData.TaskData> TaskCollection = new List<FilterData.TaskData>();
        public List<Object>? ToolbarItems { get; set; }
        public FilterHierarchyMode CurrentHierarchyMode = FilterHierarchyMode.Both;
        ...
        /// </summary>
        public async Task OnHierarchyModeChanged(ChangeEventArgs<string, HierarchyModeFields> args)
        {
