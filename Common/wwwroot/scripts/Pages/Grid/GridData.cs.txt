    ...
    public class Orders
    {
        ...
        public static List<Orders> GetAllRecords()
        {
            ...
            for (int i = 1; i < 15; i++)
            {
                ...
                orders.Add(new Orders(code + 3, "ANTON", i + 1, 4.3 * i, true, new DateOnly(1957, 11, 30), new TimeOnly(12, 00, 00), "Cholchester", "Frankenversand", "Germany", new DateTime(1996, 10, 7), "Carrera 52 con Ave. Bolívar #65-98 Llano Largo"));
                orders.Add(new Orders(code + 4, "BLONP", i + 3, 5.3 * i, false, new DateOnly(1930, 10, 22), new TimeOnly(15, 30, 00), "Marseille", "Ernst Handel", "Austria", new DateTime(1996, 12, 30), "Magazinweg 7"));
