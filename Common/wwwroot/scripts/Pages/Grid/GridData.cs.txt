...
namespace blazor_griddata
{
    ...
    public class OrderDetails
    {
        ...
        public static List<OrderDetails> GetAllRecords()
        {
            ...
            for (int i = 1; i < 15; i++)
            {
                order.Add(new OrderDetails(code + 1, "ALFKI", i + 0, 2.3 * i,  new DateTime(1991, 05, 15), "Berlin", "Simons bistro", "Denmark", new DateTime(1996, 7, 16), "Kirchgasse 6", 20* i, 40*i, 9982223864 ));
                order.Add(new OrderDetails(code + 2, "ANATR", i + 2, 3.3 * i,  new DateTime(1990, 04, 04), "Madrid", "Queen Cozinha", "Brazil", new DateTime(1996, 9, 11), "Avda. Azteca 123", 30* i, 60*i, 9972236764));
                order.Add(new OrderDetails(code + 3, "ANTON", i + 1, 4.3 * i, new DateTime(1957, 11, 30), "Cholchester", "Frankenversand", "Germany", new DateTime(1996, 10, 7), "Carrera 52 con Ave. Bolívar #65-98 Llano Largo",25* i, 50*i, 9922388124));
                order.Add(new OrderDetails(code + 4, "BLONP", i + 3, 5.3 * i,  new DateTime(1930, 10, 22), "Marseille", "Ernst Handel", "Austria", new DateTime(1996, 12, 30), "Magazinweg 7", 40* i, 80*i, 9922388904));
                order.Add(new OrderDetails(code + 5, "BOLID", i + 4, 6.3 * i, new DateTime(1953, 02, 18), "Tsawassen", "Hanari Carnes", "Switzerland", new DateTime(1997, 12, 3), "1029 - 12th Ave. S.", 45* i, 90*i, 9922377644));
                code += 5;
            }
            return order;
        }
    ...
    public class OrderData {
        ...
        public static List<OrderData> GetAllRecords()
        {
            ...
            for (int i = 1; i < 850; i++)
            {
                order.Add(new OrderData(code + i, customerID[new Random().Next(89)],2.3 * i, DateTime.Now.AddDays(-i), shipCountry[new Random().Next(21)], i%2 == 0));
            }
            return order;
        }
        public int? OrderID { get; set; }
    ...
    public class OrderPage
    {
        ...
        public static List<OrderPage> GetAllRecords()
        {
            ...
            for (int i = 1; i <= 20; i++)
            {
                students.Add(new OrderPage(Code + 1, "ALFKI", 2.3 * i, "Denmark", new DateTime(1991, 05, 15)));
                students.Add(new OrderPage(Code + 2, "ANATR", 3.3 * i, "Germany", new DateTime(1990, 04, 04)));
                students.Add(new OrderPage(Code + 3, "ANTON", 4.3 * i, "Austria", new DateTime(1957, 11, 30)));
                students.Add(new OrderPage(Code + 4, "BLONP", 5.3 * i, "Brazil", new DateTime(1930, 10, 22)));
                students.Add(new OrderPage(Code + 5, "BOLID", 6.3 * i, "Switzerland", new DateTime(1953, 02, 18)));
                Code += 5;
            }
            return students;
        }
    ...
    public class Orders
    {
        ...
        public static List<Orders> GetAllRecords()
        {
            ...
            for (int i = 1; i < 15; i++)
            {
                orders.Add(new Orders(code + 1, "ALFKI", i + 0, 2.3 * i, false, new DateOnly(1991, 05, 15), new TimeOnly(10, 00, 00), "Berlin", "Simons bistro", "Denmark", new DateTime(1996, 7, 16), "Kirchgasse 6"));
                orders.Add(new Orders(code + 2, "ANATR", i + 2, 3.3 * i, true, new DateOnly(1990, 04, 04), new TimeOnly(11, 30, 00), "Madrid", "Queen Cozinha", "Brazil", new DateTime(1996, 9, 11), "Avda. Azteca 123"));
                orders.Add(new Orders(code + 3, "ANTON", i + 1, 4.3 * i, true, new DateOnly(1957, 11, 30), new TimeOnly(12, 00, 12), "Cholchester", "Frankenversand", "Germany", new DateTime(1996, 10, 7), "Carrera 52 con Ave. Bolívar #65-98 Llano Largo"));
                orders.Add(new Orders(code + 4, "BLONP", i + 3, 5.3 * i, false, new DateOnly(1930, 10, 22), new TimeOnly(15, 30, 10), "Marseille", "Ernst Handel", "Austria", new DateTime(1996, 12, 30), "Magazinweg 7"));
                orders.Add(new Orders(code + 5, "BOLID", i + 4, 6.3 * i, true, new DateOnly(1953, 02, 18), new TimeOnly(16, 30, 00), "Tsawassen", "Hanari Carnes", "Switzerland", new DateTime(1997, 12, 3), "1029 - 12th Ave. S."));
                code += 5;
            }
            return orders;
        }
