    ...
    internal partial class SampleConfig
    {
        public List<Sample> LinearGauge { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                NotificationDescription= new string[] { @"Updated the demo with animation effect in the marker pointer." }
            },
            new Sample
            {
                Name = "Bar Pointer",
                ...
                Type = SampleType.Updated,
                NotificationDescription= new string[] { @"Updated the demo with animation effect in the bar pointer." }
            },
            new Sample
            {
                Name = "Custom Pointer",
