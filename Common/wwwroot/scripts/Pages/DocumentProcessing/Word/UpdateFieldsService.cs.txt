...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class UpdateFieldsService
    {
        ...
        public MemoryStream UpdateFields(string documentType, string button)
        {
            ...
            string dataPath = basePath + @"/data/word/template-update-fields.docx";
            ...
            string dataPathField = basePath + @"/data/word/template-update-fields.docx";
        ...
        private MailMergeDataTable GetMailMergeDataTableStock()
        {
            ...
            FileStream fs = new FileStream(@"wwwroot/data/word/stock-details.xml", FileMode.Open, FileAccess.Read);
