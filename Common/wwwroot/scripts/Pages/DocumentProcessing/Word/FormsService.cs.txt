...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class FormsService
    {
        ...
        public FormsService(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public MemoryStream Forms(string documentType)
        {
            ...
            FileStream imageStream = new FileStream(basePath + @"/images/word/image.png", FileMode.Open, FileAccess.Read);
