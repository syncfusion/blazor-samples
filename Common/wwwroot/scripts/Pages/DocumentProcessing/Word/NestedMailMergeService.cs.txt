...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class NestedMailMergeService
    {
        ...
        public MemoryStream NestedMailMerge(string Group1, string Group2, string documentType, string button)
        {
            ...
            if (Group1 == "Report")
                dataPath = basePath + @"data/word/template-report.doc";
            else
                dataPath = basePath + @"data/word/template-letter.doc";
        ...
        private MailMergeDataSet GetMailMergeDataSet(string basePath)
        {
            ...
            FileStream stream = new FileStream(basePath + @"data/word/employees.xml", FileMode.OpenOrCreate);
