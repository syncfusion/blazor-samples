...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class MailMergeEventService
    {
        ...
        public MemoryStream MailMergeEvent(string Group1, string Button)
        {
            ...
            string dataPath = basePath + @"data/word/mail-merge-event-template.doc";
        ...
        private void MergeField_ProductImage(object sender, MergeImageFieldEventArgs args)
        {
            ...
            if (args.FieldName == "ProductImage")
            {
                ...
                FileStream fs = new FileStream(@"wwwroot/images/word/" + ProductFileName, FileMode.Open, FileAccess.Read);
                args.ImageStream = fs;
            }
        }
        ...
        private MailMergeDataTable GetMailMergeDataTablePriceList()
        {
            ...
            FileStream fs = new FileStream(@"wwwroot/data/word/product-price-list.xml", FileMode.Open, FileAccess.Read);
        ...
        private MailMergeDataTable GetMailMergeDataTableProductData()
        {
            ...
            FileStream fs = new FileStream(@"wwwroot/data/word/product.xml", FileMode.Open, FileAccess.Read);
            XmlReader reader = XmlReader.Create(fs);
            if (reader == null)
                throw new Exception("reader");
            while (reader.NodeType != XmlNodeType.Element)
