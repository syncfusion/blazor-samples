...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class SalesInvoiceService
    {
        ...
        public MemoryStream CreateWordDocument(int id, string documentType, string button)
        {
            ...
            string dataPath = basePath + @"data/word/sales-invoice-demo.doc";
        ...
        private MailMergeDataTable GetTestOrder(int TestOrderId)
        {
            ...
            FileStream fs = new FileStream(@"wwwroot/data/word/test-order.xml", FileMode.Open, FileAccess.Read);
        ...
        private MailMergeDataTable GetTestOrderDetails(int TestOrderId)
        {
            ...
            FileStream fs = new FileStream(@"wwwroot/data/word/test-order-details.xml", FileMode.Open, FileAccess.Read);
            XmlReader reader = XmlReader.Create(fs);
        ...
        private MailMergeDataTable GetTestOrderTotals(int TestOrderId)
        {
            ...
            FileStream fs = new FileStream(@"wwwroot/data/word/order-totals.xml", FileMode.Open, FileAccess.Read);
            XmlReader reader = XmlReader.Create(fs);
