...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class BookmarkNavigationService
    {
        ...
        public MemoryStream BookmarkNavigation(string documentType,string button)
        {
            ...
            string dataPath = basePath + @"data/word/bookmark-template.docx";
            ...
            dataPath = basePath + @"/data/word/bookmark-template.docx";
            string dataPathTemp = basePath + @"/data/word/bkmk-document-part-template.docx";
