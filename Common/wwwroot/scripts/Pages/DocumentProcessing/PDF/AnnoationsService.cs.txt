...
{ 
    public class AnnotationsService
    {
        ...
        public AnnotationsService(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public MemoryStream CreatePdfDocument( bool flatten)
        {
            ...
            FileStream filestream = new FileStream(ResolveApplicationPath("Video.mp4"), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
			//Create rich media content with video file
            ...
            FileStream imageStream = new FileStream(ResolveApplicationPath("richmedia.jpg"), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
            ...
            filestream = new FileStream(ResolveApplicationPath("Sound.mp3"), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
            ...
            FileStream soundImageStream = new FileStream(ResolveApplicationPath("richmedia_sound.jpg"), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
