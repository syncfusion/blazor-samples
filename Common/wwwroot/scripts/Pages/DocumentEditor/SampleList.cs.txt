    ...
    internal partial class SampleConfig
    {
        public List<Sample> DocumentEditor { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                {
                    @"Updated the demo with paragraph before and after space auto type."
                }
            },
            new Sample
            {
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]
                {
                    @"Updated the demo with custom screen tip text for hyperlink."
                }
            },
            new Sample
            {
             ...
             new Sample
            {
                ...
                NotificationDescription = new string[]
                {
                    @"Updated the demo by protecting the document with comments only protection type."
                }
            },
            new Sample
            {
