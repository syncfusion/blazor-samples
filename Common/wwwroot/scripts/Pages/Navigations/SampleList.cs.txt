    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> Tabs { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @" Added the demo to show how to add dynamic tabs." },
                Type = SampleType.New
            },
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @" Added the demo to show how to render the nested tabs." },
                Type = SampleType.New
            },
            new Sample
            {
        ...
        public List<Sample> FileManager { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @"Added a demo to showcase the directory upload feature in File Manager." }
            },
            new Sample
            {
                Name = "Keyboard Navigation",
