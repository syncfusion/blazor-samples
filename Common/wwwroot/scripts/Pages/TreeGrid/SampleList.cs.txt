    ...
    internal partial class SampleConfig
    {
        public List<Sample> TreeGrid { get; set; } = new List<Sample>{
            new Sample
            {
                ...
                Type = SampleType.New,
                NotificationDescription = new string[]{ @"Added a demo that renders the overview of basic Tree Grid features" }
            },
            new Sample
            {
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @"Updated the demo by adding EnableVirtualMaskRow property to true, in which placeholder indicator displayed while the new data was loaded." },
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
            ...
            new Sample
            {
                ...
                Type = SampleType.New,
                NotificationDescription = new string[]{ @"Added a demo that renders the State Management feature of Tree Grid" }
            },
            new Sample
            {
                Name = "Context Menu",
