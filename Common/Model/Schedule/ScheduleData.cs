...
namespace BlazorDemos.Pages.Schedule.Scheduler
{
    ...
    {
        public static int GetSecureRandomInt(System.Security.Cryptography.RandomNumberGenerator rng, int minValue, int maxValue)
        {
            ...
            return (int)((ulong)minValue + (ulongRand % (ulong)range));
        }
