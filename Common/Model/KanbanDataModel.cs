...
namespace BlazorDemos.Model
{
    public class KanbanDataModel
    {
        ...
        public static IReadOnlyCollection<KanbanDataModel> GetKanbanTasks()
        {
    ...
    public class PizzaDataModel
    {
        ...
        public static IReadOnlyCollection<PizzaDataModel> GetPizzaData()
        {
            var pizzaData = new List<PizzaDataModel>
            {
                new PizzaDataModel { Id= "1", OrderID= "Order ID - #16365", Title= "Mexican Green Wave", Type= "Vegetarian", Size="Small", Category="Order", Description= "Stromboli sandwich with chili sauce", CardTags = new List<string>() { "Onions", "Pepper", "Cheese" }, ImageURL= new Uri("menu-01", UriKind.Relative), Price= "$4.79",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                ...
                new PizzaDataModel { Id = "3", OrderID = "Order ID - #16372", Title = "Chicken Golden Delight", Type = "Non-Vegetarian", Size = "Large", Category = "Order", Description = "Barbeque chicken with a topping of golden corn loaded with extra cheese", CardTags = new List<string>() { "BBQ", "Prawn" }, ImageURL = new Uri("menu-07", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                ...
                new PizzaDataModel { Id = "9", OrderID = "Order ID - #16383", Title = "Margherita", Type = "Vegetarian", Size = "Large", Category = "Ready to Deliver", Description = "Lebanese Pizza topped with tomato sauce", CardTags = new List<string>() { "Pepper", "Cheese" }, ImageURL = new Uri("menu-18", UriKind.Relative), Price = "$4.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
