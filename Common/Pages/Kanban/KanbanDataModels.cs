...
namespace Syncfusion.Blazor.KanbanDemo
{
    public class KanbanDataModel
    {
        ...
        public IReadOnlyCollection<string>? CardTags { get; init; }
        ...
        public IReadOnlyCollection<string>? ClassName { get; init; }
        public DateTime? Date { get; set; }

        public static IReadOnlyCollection<KanbanDataModel> GetTasks()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> GetCardTasks()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> GetPizzaData()
        {
            var pizzaData = new List<KanbanDataModel>
            {
                new KanbanDataModel { Id= "1", OrderID= "Order ID - #16365", Title= "Mexican Green Wave", Type= "Vegetarian", Size="Small", Category="Order", Description= "Stromboli sandwich with chili sauce", CardTags = new List<string>() { "Onions", "Pepper", "Cheese" }, ImageURL= new Uri("menu-01", UriKind.Relative), Price= "$4.79",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "2", OrderID = "Order ID - #16366", Title = "Fresh Veggie", Type = "Vegetarian", Size = "Medium", Category = "Order", Description = "Veggie with Onions and Capsicum", CardTags = new List<string>() { "Onions", "Capsicum" }, ImageURL = new Uri("menu-01", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "3", OrderID = "Order ID - #16367", Title = "Peppy Paneer", Type = "Vegetarian", Size = "Large", Category = "Ready to Serve", Description = "It's made using toppings of tomato, mozzarella cheese and fresh basil", CardTags = new List<string>() { "Onions", "Pepper", "Cheese" }, ImageURL = new Uri("menu-02", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "4", OrderID = "Order ID - #16368", Title = "Margherita", Type = "Vegetarian", Size = "Small", Category = "Menu", Description = "Lebanese Pizza topped with tomato sauce", CardTags = new List<string>() { "Onions", "Pepper", "Cheese" }, ImageURL = new Uri("menu-03", UriKind.Relative), Price = "$4.79",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "5", OrderID = "Order ID - #16369", Title = "Indian Tandoori Paneer", Type = "Vegetarian", Size = "Medium", Category = "Delivered", Description = "Tandoori Paneer with capsicum, red paprika and mint", CardTags = new List<string>() { "Paneer", "Capsicum" }, ImageURL = new Uri("menu-04", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "6", OrderID = "Order ID - #16370", Title = "Pepper Barbecue Chicken", Type = "Non-Vegetarian", Size = "Medium", Category = "Ready to Serve", Description = "Pepper Barbecue Chicken with cheese", CardTags = new List<string>() { "Chicken", "Cheese" }, ImageURL = new Uri("menu-05", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "7", OrderID = "Order ID - #16371", Title = "Chicken Sausage", Type = "Non-Vegetarian", Size = "Large", Category = "Ready to Serve", Description = "Chicken Sausage with cheese", CardTags = new List<string>() { "Cheese", "Chicken" }, ImageURL = new Uri("menu-06", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "8", OrderID = "Order ID - #16372", Title = "Chicken Golden Delight", Type = "Non-Vegetarian", Size = "Large", Category = "Order", Description = "Barbeque chicken with a topping of golden corn loaded with extra cheese", CardTags = new List<string>() { "BBQ", "Prawn" }, ImageURL = new Uri("menu-07", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "9", OrderID = "Order ID - #16373", Title = "Pepper Barbecue and Onion", Type = "Non-Vegetarian", Size = "Medium", Category = "Menu", Description = "Pepper Barbecue chicken with Onion", CardTags = new List<string>() { "Pepper", "Chicken" }, ImageURL = new Uri("menu-08", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10)},
                new KanbanDataModel { Id = "10", OrderID = "Order ID - #16374", Title = "Chicken Fiesta", Type = "Non-Vegetarian", Size = "Small", Category = "Delivered", Description = "Grilled Chicken Rashers with Peri-Peri chicken, Onion and Capsicum", CardTags = new List<string>() { "Chicken", "Capsicum" }, ImageURL = new Uri("menu-13", UriKind.Relative), Price = "$4.79",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "11", OrderID = "Order ID - #16375", Title = "Double Cheese Margherita", Type = "Vegetarian", Size = "Medium", Category = "Delivered", Description = "Margherita with chili sauce and double Cheese", CardTags = new List<string>() { "Onions", "Pepper" }, ImageURL = new Uri("menu-10", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "12", OrderID = "Order ID - #16376", Title = "Veggie Paradise", Type = "Vegetarian", Size = "Large", Category = "Menu", Description = "Veggie Delight with Golden Corn, Black Olives, Capsicum and red Paprika", CardTags = new List<string>() { "Corn", "Capsicum" }, ImageURL = new Uri("menu-11", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "13", OrderID = "Order ID - #16377", Title = "Cheese and Corn", Type = "Vegetarian", Size = "Large", Category = "Order", Description = "Cheese with golden corn", CardTags = new List<string>() {"Cheese", "Corn" }, ImageURL = new Uri("menu-12", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "14", OrderID = "Order ID - #16378", Title = "Chicken Tikka", Type = "Non-Vegetarian", Size = "Medium", Category = "Ready to Serve", Description = "Tandoori masala with Chicken Tikka, Onion, red paprika and mint", CardTags = new List<string>() { "Chicken", "Tikka" }, ImageURL = new Uri("menu-14", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "15", OrderID = "Order ID - #16379", Title = "Chicken Dominator", Type = "Non-Vegetarian", Size = "Small", Category = "Menu", Description = "Double Pepper Barbecue Chicken with Peri-Peri Chicken, Chicken Tikka, Grilled and Rashers", CardTags = new List<string>() { "Pepper", "Chicken" }, ImageURL = new Uri("menu-15", UriKind.Relative), Price = "$4.79",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "16", OrderID = "Order ID - #16380", Title = "Deluxe Veggie", Type = "Vegetarian", Size = "Medium", Category = "Delivered", Description = "Onions and Capsicum those delectable mushrooms with paneer and golden corn to top it all", CardTags = new List<string>() {"Mushrooms", "Corn" }, ImageURL = new Uri("menu-16", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "17", OrderID = "Order ID - #16381", Title = "Farm House", Type = "Vegetarian", Size = "Large", Category = "Menu", Description = "Crunchy, crisp capsicum, succulent mushrooms and fresh tomatoes", CardTags = new List<string>() { "Capsicum", "Mushrooms" }, ImageURL = new Uri("menu-17", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "18", OrderID = "Order ID - #16382", Title = "Veg Extravaganza", Type = "Vegetarian", Size = "Large", Category = "Served", Description = "Pizza with corn, olives, onions, capsicum, tomatoes and jalapeno with cheese to go all around", CardTags = new List<string>() { "Corn", "Mushrooms" }, ImageURL = new Uri("menu-18", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "19", OrderID = "Order ID - #16383", Title = "Margherita", Type = "Vegetarian", Size = "Large", Category = "Ready to Deliver", Description = "Lebanese Pizza topped with tomato sauce", CardTags = new List<string>() { "Pepper", "Cheese" }, ImageURL = new Uri("menu-19", UriKind.Relative), Price = "$4.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "20", OrderID = "Order ID - #16384", Title = "Pepper Barbecue and Onion", Type = "Non-Vegetarian", Size = "Medium", Category = "Ready to Deliver", Description = "Pepper Barbecue chicken with Onion", CardTags = new List<string>() { "Onions", "Chicken" }, ImageURL = new Uri("menu-20", UriKind.Relative), Price = "$11.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "21", OrderID = "Order ID - #16385", Title = "Veggie Paradise", Type = "Vegetarian", Size = "Large", Category = "Ready to Deliver", Description = "Veggie Delight with Golden Corn, Black Olives, Capsicum and red Paprika", CardTags = new List<string>() { "Corn", "Pepper" }, ImageURL = new Uri("menu-21", UriKind.Relative), Price = "$14.99",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) },
                new KanbanDataModel { Id = "22", OrderID = "Order ID - #16386", Title = "Chicken Dominator", Type = "Non-Vegetarian", Size = "Small", Category = "Ready to Deliver", Description = "Double Pepper Barbecue Chicken with Peri-Peri Chicken, Chicken Tikka, Grilled and Rashers", CardTags = new List<string>() { "Pepper", "Chicken" }, ImageURL = new Uri("menu-22", UriKind.Relative), Price = "$4.79",Date = new DateTime(DateTime.Now.Year, DateTime.Now.Month,10) }
            };
            return pizzaData;
        }

        public static IReadOnlyCollection<KanbanDataModel> SortDropDowns()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> ColumnDropDowns()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> StatusData()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> ApiData()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> DialogStatus()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> AssigneeData()
        {
        ...
        public static IReadOnlyCollection<KanbanDataModel> PriorityData()
        {
