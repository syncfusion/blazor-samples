    ...
    public class KanbanDataModel
    {
        ...
        public List<KanbanDataModel> GetPizzaData()
        {
            var pizzaData = new List<KanbanDataModel>
            {
                ...
                new KanbanDataModel { Id = "12", OrderID = "Order ID - #16376", Title = "Veggie Paradise", Type = "Vegetarian", Size = "Large", Category = "Menu", Description = "Veggie Delight with Golden Corn, Black Olives, Capsicum and red Paprika", CardTags = new List<string>() { "Corn", "Capsicum" }, ImageURL = "menu-11", Price = "$14.99" },
                ...
                new KanbanDataModel { Id = "18", OrderID = "Order ID - #16382", Title = "Veg Extravaganza", Type = "Vegetarian", Size = "Large", Category = "Served", Description = "Pizza with corn, olives, onions, capsicum, tomatoes and jalapeno with cheese to go all around", CardTags = new List<string>() { "Corn", "Mushrooms" }, ImageURL = "menu-18", Price = "$14.99" },
                ...
                new KanbanDataModel { Id = "21", OrderID = "Order ID - #16385", Title = "Veggie Paradise", Type = "Vegetarian", Size = "Large", Category = "Ready to Deliver", Description = "Veggie Delight with Golden Corn, Black Olives, Capsicum and red Paprika", CardTags = new List<string>() { "Corn", "Pepper" }, ImageURL = "menu-21", Price = "$14.99" },
