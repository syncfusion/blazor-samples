    ...
    internal partial class SampleConfig
    {
        public List<Sample> Diagram { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                MetaTitle = "Blazor Diagram: Interactive Periodic Table | Syncfusion",
                MetaDescription = "Explore an interactive periodic table using Syncfusion® Blazor Diagram with color-coded elements, hover details, and dynamic highlights for engaging learning.",
            },
            new Sample
            {
