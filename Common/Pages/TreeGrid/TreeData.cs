...
namespace BlazorDemos.Pages.TreeGrid
{
    ...
    public class BusinessObject
    {
        ...
        public Collection<BusinessObject> Children { get; } = new();
    ...
    public static class TreeData
    {
        ...
        public static Collection<BusinessObject> GetDefaultData()
        {
            Collection<BusinessObject> BusinessObjectCollection = new Collection<BusinessObject>();
