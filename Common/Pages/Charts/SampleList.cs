    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> ChartWizard { get; set; } = new List<Sample>
        {
            new Sample
            {
                ...
                FileName = "DefaultFunctionalities.razor",
                MetaTitle = "Blazor Chart Wizard Component | Guided Chart Creation | Syncfusion",
                HeaderText = "Blazor Chart Wizard - Interactive Chart Creation Tool",
                MetaDescription = "Blazor Chart Wizard demo shows a step-by-step approach to create and customize charts with intuitive controls for data binding, styling, chart type selection.",
                NotificationDescription = new string[]{ @"Experience how the Chart Wizard guides you through data selection, chart type configuration, and styling options to create fully customized charts with ease." }
            },
            ...
            new Sample
            {
                ...
                MetaTitle = "Blazor Chart Wizard with Grid Integration | Syncfusion",
                HeaderText = "Blazor Chart Wizard - Integrated with Grid",
                MetaDescription = "Explore integrating Blazor Chart Wizard with a data grid. This demo lets you create, customize, and visualize charts interactively using intuitive controls.",
                NotificationDescription = new string[]{ @"Understand how the Chart Wizard seamlessly interacts with grid data, enabling you to generate charts directly from table entries and refine their appearance through intuitive controls." }
            },
            ...
            new Sample
            {
                ...
                MetaTitle = "Blazor Chart Wizard with Serialization | Syncfusion",
                HeaderText = "Blazor Chart Wizard - Serialization",
                MetaDescription = "Serialize chart settings in the Blazor Chart Wizard to save user configurations in JSON format and reload them easily for a seamless, customizable experience.",
                NotificationDescription = new string[]{ @"Learn how to save and load chart settings using the Blazor Chart Wizard. This sample shows how chart configurations can be serialized and restored easily." }
            }
        };
    }
