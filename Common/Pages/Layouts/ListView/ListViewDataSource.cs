...
namespace BlazorDemos.Pages.Layouts.ListView
{
    ...
    {
        public static readonly IReadOnlyList<NewsDataModel> NewsData = new List<NewsDataModel>() {
            new NewsDataModel {
        ...
        public static readonly IReadOnlyList<NewsDataModel> DataSource = new List<NewsDataModel>() {
            new NewsDataModel {
                Id = "01",
        ...
        public static readonly IReadOnlyList<CallHistoryModel> CallHistories = new List<CallHistoryModel>() {
        ...
        public static IReadOnlyList<CallHistoryModel> GetReceivedData()
        {
        ...
        public static IReadOnlyList<CallHistoryModel> GetMissedData()
        {
            List<CallHistoryModel> temp = new List<CallHistoryModel>();
            foreach (CallHistoryModel item in CallHistories)
            {
    ...
    public class NewsDataModel
    {
        ...
        public IReadOnlyList<NewsDataModel>? Child { get; internal set; }
