    ...
    internal partial class SampleConfig
    {
        public List<Sample> Maps { get; set; } = new List<Sample>{
             ...
             new Sample
            {
                ...
                FileName = "OSMNavigationLine.razor",
                Type = SampleType.None
            },
            new Sample
            {
                ...
                Type = SampleType.New,
                NotificationDescription= new string[] { @"Added a demo for displaying Bing maps in various views, such as aerial view, road view, and aerial view with labels." }
            },
            new Sample
            {
                Name = "Legend",
            ...
            new Sample
            {
                ...
                Type = SampleType.Updated,
                NotificationDescription= new string[] { @"Updated the demo with animation for the Map layer. The animation duration can be adjusted using a slider." }
            },            
             new Sample
            {
