...
{ 
    public class GraphicBrushesService
    {
        ...
        public MemoryStream CreatePdfDocument()
        {
            ...
            //Read the file
            FileStream file = new FileStream(ResolveApplicationPath("simple.jpg"), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
            ...
            FileStream fs = new FileStream(ResolveApplicationPath("rgb.icc"), FileMode.Open, FileAccess.Read);
