...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class EmployeeReportService
    {
        ...
        public MemoryStream EmployeeReport(string documentType, string button)
        {
            ...
            string dataPathEmployee = basePath + @"/data/word/employees-report-demo.doc";
        ...
        private MailMergeDataTable GetMailMergeDataTableEmployee()
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/data/word/employees-list.xml", FileMode.Open, FileAccess.Read);
