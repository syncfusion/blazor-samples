...
namespace BlazorDemos.Data.DocumentProcessing.Word
{
    public class AdvancedReplaceService
    {
        ...
        public MemoryStream AdvancedReplace(string documentType, string button)
        {
            ...
            string dataPathTemp = basePath + @"/data/word/source-template1.doc";
            string dataPathTemplate = basePath + @"/data/word/source-template2.doc";
            string dataPathMaster = basePath + @"/data/word/master-template.doc";
