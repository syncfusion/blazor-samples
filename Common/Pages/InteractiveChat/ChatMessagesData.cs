...
namespace Syncfusion.Blazor.InteractiveChatDemo
{
    ...
    {
        public static IReadOnlyList<UserModel> GetMentionUsers()
        {
        ...
        public static IReadOnlyList<ChatMessage> GetApiChatMessages() {
        ...
        public static IReadOnlyList<ChatMessage> GetUserChatMessages()
        {
        ...
        public static UserModel GetSpecificUser(string Id, string Username, string ImageDir, string BgColor, string StatusIconCss = "")
        {
            return new UserModel()
            {
                ...
                StatusIconCss = StatusIconCss
            };
        }
        public static IReadOnlyList<string> GetChatSuggestions()
        {
            return new List<string> { "Awesome!", "What kind of painting ?" };
        }

        public static IReadOnlyList<TemplateMessageData> GetTemplateMessages()
        {
        ...
        public static IReadOnlyList<ListViewData> GetListItems()
        {
        ...
        public static IReadOnlyList<IReadOnlyList<ChatMessage>> GetChatMessages()
        {
        ...
        public static IReadOnlyList<string> GetBotSuggestions()
        {
            return new List<string> { "Bedroom", "Kitchen" };
        }

        public static IReadOnlyList<TemplateMessageData> GetBotData()
        {
            return new List<TemplateMessageData>()
            {
                new TemplateMessageData()
