...
namespace BlazorDemos.Pages.Schedule
{
    ...
    public class TechEventOrganizerData
    {
        ...
        public Collection<string>? EventTags { get; set; }

        public static Collection<TechEventOrganizerData> GetEventData()
        {
            Collection<TechEventOrganizerData> employeeData = new Collection<TechEventOrganizerData>()
            {
                new TechEventOrganizerData {
                    ...
                    EventTags = new Collection<string> { "Artificial Intelligence", "Business Automation", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id = 2,
                    Title = "AI for Business Automation",
                    ...
                    EventTags = new Collection<string> { "Networking", "Relaxation" }
                },
                new TechEventOrganizerData {
                    Id= 3,
                    Title= "AI for Business Automation",
                    ...
                    TargetAudience= "Developers, Engineers, Business Analysts",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Artificial Intelligence", "Business Intelligence", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 4,
                    Title= "AI for Business Automation",
                    ...
                    TargetAudience= "Developers, Engineers, Business Analysts",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Artificial Intelligence", "Automation", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 5,
                    Title= "AI for Business Automation",
                    ...
                    TargetAudience= "All attendees",
                    EventLevel= "All levels",
                    EventTags= new Collection<string> { "Networking", "Lunch" }
                },
                new TechEventOrganizerData {
                    Id= 6,
                    Title= "AI for Business Automation",
                    ...
                    TargetAudience= "Developers, Engineers, Business Analysts",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Artificial Intelligence", "Customer Engagement", "Personalization" }
                },
                new TechEventOrganizerData {
                    Id = 7,
                    Title = "AI for Business Automation",
                    ...
                    EventLevel = "All levels",
                    EventTags = new Collection<string> { "Networking", "Coffee Break" }
                },
                new TechEventOrganizerData {
                    Id = 8,
                    Title = "AI for Business Automation",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Artificial Intelligence", "Business Automation", "Future Trends" }
                },
                new TechEventOrganizerData {
                    Id = 10,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Database Management", "SQL", "Data Modeling" }
                },
                new TechEventOrganizerData {
                    Id = 11,
                    Title = "Database Systems and Data Management",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "SQL Optimization", "Performance Tuning", "Database Administration" }
                },
                new TechEventOrganizerData {
                    Id = 12,
                    Title = "Database Systems and Data Management",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Database Security", "Encryption", "Data Protection" }
                },
                new TechEventOrganizerData {
                    Id = 13,
                    Title = "Database Systems and Data Management",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "NoSQL", "Distributed Databases", "Database Design" }
                },
                new TechEventOrganizerData {
                    Id = 14,
                    Title = "Database Systems and Data Management",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Database Performance", "Troubleshooting", "Monitoring" }
                },
                new TechEventOrganizerData {
                    Id = 15,
                    Title = "Database Systems and Data Management",
                    ...
                    TargetAudience = "All Participants",
                    EventLevel = "All Levels",
                    EventTags = new Collection<string> { "Networking", "Relax" }
                },
                new TechEventOrganizerData {
                    Id = 16,
                    Title = "Database Systems and Data Management",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Future of Databases", "Emerging Trends", "Panel Discussion" }
                },
                new TechEventOrganizerData {
                    Id = 17,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Networking", "Career Development", "Professional Growth" }
                },
                new TechEventOrganizerData {
                    Id = 18,
                    Title = "Networking Strategies for Tech Professionals",
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Networking", "LinkedIn", "Career Growth" }
                },
                new TechEventOrganizerData {
                    Id = 19,
                    Title = "Networking Strategies for Tech Professionals",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Networking", "Conferences", "Tech Meetups" }
                },
                new TechEventOrganizerData {
                    Id = 20,
                    Title = "Networking Strategies for Tech Professionals",
                    ...
                    TargetAudience = "Developers, Entrepreneurs, Job Seekers",
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Networking", "Online Presence", "Career Growth" }
                },
                new TechEventOrganizerData {
                    Id = 21,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Cloud Computing", "Cloud Services", "Infrastructure as a Service" }
                },
                new TechEventOrganizerData {
                    Id = 22,
                    Title = "Cloud Computing and Architecture",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cloud Providers", "Cloud Architecture", "Scalability" }
                },
                new TechEventOrganizerData {
                    Id = 23,
                    Title = "Cloud Computing and Architecture",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cloud Architecture", "Scalability", "Cloud Solutions" }
                },
                new TechEventOrganizerData {
                    Id = 24,
                    Title = "Cloud Computing and Architecture",
                    ...
                    TargetAudience = "All attendees",
                    EventLevel = "All levels",
                    EventTags = new Collection<string> { "Networking", "Break" }
                },
                new TechEventOrganizerData {
                    Id = 25,
                    Title = "Cloud Computing and Architecture",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cloud Security", "Data Protection", "Compliance" }
                },
                new TechEventOrganizerData {
                    Id = 26,
                    Title = "Cloud Computing and Architecture",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Containers", "Cloud-Native", "Kubernetes" }
                },
                new TechEventOrganizerData {
                    Id = 27,
                    Title = "Cloud Computing and Architecture",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cloud Computing", "Future Trends", "Emerging Technologies" }
                },
                new TechEventOrganizerData {
                    Id = 28,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "DevOps", "Continuous Integration", "Agile Development" }
                },
                new TechEventOrganizerData {
                    Id = 29,
                    Title = "DevOps and Continuous Integration",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "CI/CD", "Jenkins", "Automation" }
                },
                new TechEventOrganizerData {
                    Id = 30,
                    Title = "DevOps and Continuous Integration",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Scaling DevOps", "Enterprise Solutions", "Agile Development" }
                },
                new TechEventOrganizerData {
                    Id = 31,
                    Title = "DevOps and Continuous Integration",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "CI/CD", "Jenkins", "Advanced Automation" }
                },
                new TechEventOrganizerData {
                    Id = 32,
                    ...
                    TargetAudience = "Security Engineers, IT Professionals, Developers",
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Cybersecurity", "IT Infrastructure", "Security" }
                },
                new TechEventOrganizerData {
                    Id = 33,
                    Title = "Cybersecurity in Modern IT Infrastructure",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Network Security", "Threats", "Infrastructure" }
                },
                new TechEventOrganizerData {
                    Id = 35,
                    Title = "Cybersecurity in Modern IT Infrastructure",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Firewall", "IDS", "Network Security" }
                },
                new TechEventOrganizerData {
                    Id = 36,
                    Title = "Cybersecurity in Modern IT Infrastructure",
                    ...
                    TargetAudience = "Security Engineers, IT Professionals, Developers",
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Encryption", "Data Protection", "Security" }
                },
                new TechEventOrganizerData {
                    Id = 37,
                    Title = "Cybersecurity in Modern IT Infrastructure",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cloud Security", "Cybersecurity", "Cloud Infrastructure" }
                },
                new TechEventOrganizerData {
                    Id = 38,
                    Title = "Cybersecurity in Modern IT Infrastructure",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Incident Response", "Cybersecurity", "Recovery" }
                },
                new TechEventOrganizerData {
                    Id = 40,
                    Title = "Cybersecurity in Modern IT Infrastructure",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cybersecurity", "Future Trends", "Panel Discussion" }
                },
                new TechEventOrganizerData {
                    Id = 41,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Data Science", "Big Data", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id = 42,
                    Title = "Data Science and Machine Learning Fundamentals",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Machine Learning", "Algorithms", "Data Science" }
                },
                new TechEventOrganizerData {
                    Id = 43,
                    Title = "Data Science and Machine Learning Fundamentals",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Supervised Learning", "Unsupervised Learning", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id = 44,
                    Title = "Data Science and Machine Learning Fundamentals",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Deep Learning", "Neural Networks", "AI" }
                },
                new TechEventOrganizerData {
                    Id = 45,
                    Title = "Data Science and Machine Learning Fundamentals",
                    ...
                    TargetAudience = "All Attendees",
                    EventLevel = "All levels",
                    EventTags = new Collection<string> { "Break", "Networking" }
                },
                new TechEventOrganizerData {
                    Id = 46,
                    Title = "Data Science and Machine Learning Fundamentals",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Model Evaluation", "Performance", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id = 47,
                    Title = "Data Science and Machine Learning Fundamentals",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Ethics", "Data Science", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id = 48,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Blockchain", "Cryptocurrency", "Technology" }
                },
                new TechEventOrganizerData {
                    Id = 49,
                    Title = "Blockchain and Cryptocurrency Fundamentals",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Bitcoin", "Cryptocurrency", "Blockchain" }
                },
                new TechEventOrganizerData {
                    Id = 50,
                    Title = "Blockchain and Cryptocurrency Fundamentals",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Blockchain", "Consensus Algorithms", "Decentralization" }
                },
                new TechEventOrganizerData {
                    Id = 52,
                    Title = "Blockchain and Cryptocurrency Fundamentals",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Smart Contracts", "DApps", "Ethereum" }
                },
                new TechEventOrganizerData {
                    Id = 54,
                    Title = "Blockchain and Cryptocurrency Fundamentals",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Enterprise Blockchain", "Business Applications", "Security" }
                },
                new TechEventOrganizerData {
                    Id = 55,
                    Title = "Blockchain and Cryptocurrency Fundamentals",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Blockchain Future", "Cryptocurrency Trends", "Innovation" }
                },
                new TechEventOrganizerData {
                    Id = 56,
                    Title = "Blockchain and Cryptocurrency Fundamentals",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cryptocurrency Regulation", "Blockchain", "Panel Discussion" }
                },
                new TechEventOrganizerData {
                    Id = 57,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "IoT", "Smart Solutions", "Technology" }
                },
                new TechEventOrganizerData {
                    Id = 58,
                    Title = "Internet of Things (IoT) for Smart Solutions",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "IoT Devices", "Architecture", "Networking" }
                },
                new TechEventOrganizerData {
                    Id = 59,
                    Title = "Internet of Things (IoT) for Smart Solutions",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "IoT Security", "Data Protection", "Internet of Things" }
                },
                new TechEventOrganizerData {
                    Id = 60,
                    Title = "Internet of Things (IoT) for Smart Solutions",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "IoT Data", "Analytics", "Big Data" }
                },
                new TechEventOrganizerData {
                    Id= 62,
                    Title= "Internet of Things (IoT) for Smart Solutions",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Smart Cities", "IoT", "Urban Planning" }
                },
                new TechEventOrganizerData {
                    Id= 63,
                    Title= "Internet of Things (IoT) for Smart Solutions",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Future IoT", "Technology Trends", "Innovation" }
                },
                new TechEventOrganizerData {
                    Id= 64,
                    ...
                    EventLevel= "Beginner",
                    EventTags= new Collection<string> { "Data Science", "Data Analysis", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 65,
                    Title= "Data Science and Machine Learning",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Supervised Learning", "Algorithms", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 66,
                    Title= "Data Science and Machine Learning",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Unsupervised Learning", "Clustering", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 67,
                    Title= "Data Science and Machine Learning",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Deep Learning", "Neural Networks", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 69,
                    Title= "Data Science and Machine Learning",
                    ...
                    TargetAudience= "Data Scientists, Machine Learning Engineers",
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Model Evaluation", "Performance Metrics", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 70,
                    Title= "Data Science and Machine Learning",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Deployment", "Machine Learning", "Production" }
                },
                new TechEventOrganizerData {
                    Id = 71,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Cloud Computing", "IaaS", "PaaS", "SaaS" }
                },
                new TechEventOrganizerData {
                    Id = 72,
                    Title = "Cloud Computing for Scalability",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cloud Scalability", "Load Balancing", "Auto-Scaling" }
                },
                new TechEventOrganizerData {
                    Id = 74,
                    Title = "Cloud Computing for Scalability",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cloud Security", "Data Protection", "Encryption" }
                },
                new TechEventOrganizerData {
                    Id = 76,
                    Title = "Cloud Computing for Scalability",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cloud Databases", "Storage Solutions", "AWS", "Google Cloud" }
                },
                new TechEventOrganizerData {
                    Id = 77,
                    Title = "Cloud Computing for Scalability",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Multi-cloud", "Hybrid Cloud", "Cloud Architecture" }
                },
                new TechEventOrganizerData {
                    Id = 78,
                    Title = "Cloud Computing for Scalability",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Serverless", "Cloud Functions", "Scalability" }
                },
                new TechEventOrganizerData {
                    Id = 79,
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Network Automation", "IT Management", "Orchestration" }
                },
                new TechEventOrganizerData {
                    Id = 80,
                    Title = "Network Automation and Orchestration",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Ansible", "Puppet", "Chef", "Network Automation" }
                },
                new TechEventOrganizerData {
                    Id= 81,
                    Title= "Network Automation and Orchestration",
                    ...
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "SDN", "Network Automation", "Software-Defined" }
                },
                new TechEventOrganizerData {
                    Id= 82,
                    Title= "Network Automation and Orchestration",
                    ...
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "Kubernetes", "Network Orchestration", "Automation" }
                },
                new TechEventOrganizerData {
                    Id= 83,
                    Title= "Network Automation and Orchestration",
                    ...
                    EventLevel= "Advanced",
                    EventTags = new Collection<string> { "Network Security", "Automation", "Threat Detection" }
                },
                new TechEventOrganizerData {
                    Id= 84,
                    ...
                    EventLevel= "Advanced",
                    EventTags = new Collection<string> { "Cybersecurity", "Ransomware", "Threats" }
                },
                new TechEventOrganizerData {
                    Id= 85,
                    Title= "Advanced Cybersecurity Threats and Mitigations",
                    ...
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "Phishing", "Social Engineering", "Cybersecurity" }
                },
                new TechEventOrganizerData {
                    Id= 86,
                    Title= "Advanced Cybersecurity Threats and Mitigations",
                    ...
                    EventLevel= "Advanced",
                    EventTags = new Collection<string> { "Malware", "Ransomware", "Cybersecurity" }
                },
                new TechEventOrganizerData {
                    Id= 87,
                    Title= "Advanced Cybersecurity Threats and Mitigations",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel= "Advanced",
                    EventTags = new Collection<string> { "Network Security", "Intrusion Detection", "Firewalls" }
                },
                new TechEventOrganizerData {
                    Id= 89,
                    Title= "Advanced Cybersecurity Threats and Mitigations",
                    ...
                    EventLevel= "Advanced",
                    EventTags = new Collection<string> { "APT", "Cybersecurity", "Advanced Threats" }
                },
                new TechEventOrganizerData {
                    Id= 90,
                    Title= "Advanced Cybersecurity Threats and Mitigations",
                    ...
                    EventLevel= "Advanced",
                    EventTags = new Collection<string> { "Incident Response", "Forensics", "Cybersecurity" }
                },
                new TechEventOrganizerData {
                    Id= 91,
                    ...
                    EventLevel= "Beginner",
                    EventTags= new Collection<string> { "Blockchain", "Cryptocurrency", "Tech Innovations" }
                },
                new TechEventOrganizerData {
                    Id= 92,
                    Title= "Blockchain and Cryptocurrency Technologies",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Smart Contracts", "DApps", "Blockchain" }
                },
                new TechEventOrganizerData {
                    Id= 93,
                    Title= "Blockchain and Cryptocurrency Technologies",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Cryptocurrency Mining", "PoW", "PoS" }
                },
                new TechEventOrganizerData {
                    Id= 94,
                    Title= "Blockchain and Cryptocurrency Technologies",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Blockchain Use Cases", "Tech Innovations", "Industry Applications" }
                },
                new TechEventOrganizerData {
                    Id= 95,
                    Title= "Blockchain and Cryptocurrency Technologies",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Blockchain Security", "Privacy", "Vulnerabilities" }
                },
                new TechEventOrganizerData {
                    Id= 96,
                    Title= "Blockchain and Cryptocurrency Technologies",
                    ...
                    TargetAudience= "Blockchain Enthusiasts, Developers, Entrepreneurs",
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Blockchain Future", "DeFi", "Tech Innovations" }
                },
                new TechEventOrganizerData {
                    Id= 97,
                    ...
                    EventLevel= "Beginner",
                    EventTags= new Collection<string> { "React", "Web Development", "Frontend" }
                },
                new TechEventOrganizerData {
                    Id= 98,
                    Title= "Modern Web Development and Frameworks",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "React", "State Management", "JavaScript" }
                },
                new TechEventOrganizerData {
                    Id= 99,
                    Title= "Modern Web Development and Frameworks",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "CSS", "Grid", "Flexbox" }
                },
                new TechEventOrganizerData {
                    Id= 100,
                    Title= "Modern Web Development and Frameworks",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Next.js", "Server-Side Rendering", "React" }
                },
                new TechEventOrganizerData {
                    Id= 101,
                    Title= "Modern Web Development and Frameworks",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Redux", "React", "State Management" }
                },
                new TechEventOrganizerData {
                    Id= 102,
                    Title= "Modern Web Development and Frameworks",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "JavaScript", "Performance Optimization", "Web Development" }
                },
                new TechEventOrganizerData {
                    Id= 103,
                    ...
                    EventLevel= "Beginner",
                    EventTags= new Collection<string> { "Cloud Computing", "IaaS", "PaaS" }
                },
                new TechEventOrganizerData {
                    Id= 104,
                    Title= "Cloud Infrastructure and Kubernetes",
                    ...
                    TargetAudience= "DevOps Engineers, Cloud Architects, Developers",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Kubernetes", "Containerization", "DevOps" }
                },
                new TechEventOrganizerData {
                    Id= 105,
                    Title= "Cloud Infrastructure and Kubernetes",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "CI/CD", "Kubernetes", "Automation" }
                },
                new TechEventOrganizerData {
                    Id= 106,
                    Title= "Cloud Infrastructure and Kubernetes",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Scaling", "Kubernetes", "Cloud Infrastructure" }
                },
                new TechEventOrganizerData {
                    Id= 107,
                    Title= "Cloud Infrastructure and Kubernetes",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Monitoring", "Kubernetes", "Troubleshooting" }
                },
                new TechEventOrganizerData {
                    Id= 108,
                    Title= "Cloud Infrastructure and Kubernetes",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Kubernetes", "Security", "Best Practices" }
                },
                new TechEventOrganizerData {
                    Id= 109,
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience= "All Participants",
                    EventLevel= "All Levels",
                    EventTags = new Collection<string> { }
                },
                new TechEventOrganizerData {
                    Id = 111,
                    Title = "Artificial Intelligence and Data Science",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Deep Learning", "Neural Networks", "Artificial Intelligence" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience = "AI Engineers, Data Scientists",
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Natural Language Processing", "AI", "Text Analytics" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Computer Vision", "AI", "Image Processing" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "AI", "Healthcare", "Medical Tech" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "AI", "Autonomous Vehicles", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id= 116,
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience= "DevOps Engineers, Cloud Engineers",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "CI/CD", "Jenkins", "Kubernetes" }
                },
                new TechEventOrganizerData {
                    Id= 120,
                    Title= "Cloud Computing and DevOps",
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience= "Cloud Engineers, DevOps Engineers",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Terraform", "Cloud Automation", "Infrastructure as Code" }
                },
                new TechEventOrganizerData {
                    Id= 122,
                    Title= "Cloud Computing and DevOps",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Serverless", "Cloud Computing", "DevOps" }
                },
                new TechEventOrganizerData {
                    Id= 123,
                    Title= "Cloud Computing and DevOps",
                    ...
                    TargetAudience= "Cloud Engineers, DevOps Engineers",
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Ansible", "Cloud Automation", "Infrastructure Management" }
                },
                new TechEventOrganizerData {
                    Id= 124,
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Cloud Security", "Encryption", "Compliance" }
                },
                new TechEventOrganizerData {
                    Id= 125,
                    Title= "Cloud Infrastructure and Security",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "IAM", "Cloud Security", "Access Control" }
                },
                new TechEventOrganizerData {
                    Id= 126,
                    Title= "Cloud Infrastructure and Security",
                    ...
                    TargetAudience= "Security Engineers, DevOps Engineers",
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Cloud Security", "Vulnerability Management", "Risk Remediation" }
                },
                new TechEventOrganizerData {
                    Id= 127,
                    Title= "Cloud Infrastructure and Security",
                    ...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Disaster Recovery", "Business Continuity", "Cloud Security" }
                },
                new TechEventOrganizerData {
                    Id= 128,
                    Title= "Cloud Infrastructure and Security",
                    ...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Cloud Network Security", "Encryption", "Firewall" }
                },
                new TechEventOrganizerData {
                    Id = 129,
                    Title = "Cloud Infrastructure and Security",
                    ...
                    TargetAudience = "Security Engineers, Cloud Engineers",
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Zero Trust", "Cloud Security", "Network Security" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Beginner",
                    EventTags = new Collection<string> { "Networking", "Cloud", "Infrastructure" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "SDN", "Cloud", "Networking" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Virtualization", "NFV", "Cloud Infrastructure" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cloud Networking", "AWS", "Azure", "GCP" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience = "Network Engineers, Cloud Architects",
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "5G", "Cloud Integration", "Networking" }
                },
                new TechEventOrganizerData {
                    Id = 135,
                    Title = "Networking and Cloud Infrastructure",
                    ...
                    TargetAudience = "Network Engineers, Cloud Engineers",
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Cloud Networking", "Load Balancing", "Network Scaling" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "BGP", "Networking", "Routing" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience = "Network Engineers, Cloud Engineers",
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "IPv6", "Cloud Networking", "Networking" }
                },
                new TechEventOrganizerData {
                    Id = 138,
                    Title = "Advanced Networking Techniques",
                    ...
                    TargetAudience = "Network Engineers, Cloud Architects",
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "SDN", "Networking", "Cloud Architecture" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "VLAN", "Network Security", "Cloud" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Network Automation", "Ansible", "Python" }
                },
                new TechEventOrganizerData {
                    Id= 141,
                    Title= "Advanced Networking Techniques",
                    ...
                    TargetAudience= "Network Engineers, Cloud Engineers",
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "Network Monitoring", "Cloud Networking", "Optimization" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "Cloud Storage", "Optimization", "Cost Management" }
                },
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience= "Cloud Engineers, Architects",
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "Auto-scaling", "Cloud Infrastructure", "Cloud Optimization" }
                },
                new TechEventOrganizerData {
                    Id = 144,
                    Title = "Cloud Infrastructure Optimization",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cost Optimization", "Cloud Economics", "Cloud Management" }
                },
                new TechEventOrganizerData {
                    Id = 145,
                    Title = "Cloud Infrastructure Optimization",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Multi-cloud", "Cloud Management", "Cloud Optimization" }
                },
                new TechEventOrganizerData {
                    Id = 146,
                    Title = "Cloud Infrastructure Optimization",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Cloud Databases", "Optimization", "Performance" }
                },
                new TechEventOrganizerData {
                    Id = 147,
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "IAM", "Cloud Security", "Access Management" }
                },
                new TechEventOrganizerData {
                    Id = 149,
                    Title = "Cloud Security and Privacy",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "API Security", "Microservices", "Cloud Security" }
                },
                new TechEventOrganizerData {
                    Id = 150,
                    Title = "Cloud Security and Privacy",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Compliance", "Cloud Security", "Regulatory Requirements" }
                },
                new TechEventOrganizerData {
                    Id = 152,
                    Title = "Cloud Security and Privacy",
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Incident Response", "Cloud Security", "Security Mitigation" }
                },
                new TechEventOrganizerData {
                    Id = 153,
                    Title = "Cloud Security and Privacy",
                    ...
                    TargetAudience = "Security Engineers, Cloud Architects",
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Encryption", "Cloud Security", "Data Protection" }
                },
                new TechEventOrganizerData {
                    Id = 154,
                    ...
                    TargetAudience = "DevOps Engineers, Cloud Engineers",
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "DevOps", "Cloud Automation", "CI/CD" }
                },
                new TechEventOrganizerData {
                    Id = 155,
                    Title = "Cloud DevOps and Automation",
                    ...
                    TargetAudience = "DevOps Engineers, Cloud Architects",
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "IaC", "Cloud Automation", "Terraform" }
                },
                new TechEventOrganizerData {
                    Id = 156,
                    Title = "Cloud DevOps and Automation",
                ...
                new TechEventOrganizerData {
                    ...
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "CI/CD", "Cloud Applications", "DevOps" }
                },
                new TechEventOrganizerData {
                    Id = 158,
                    Title = "Cloud DevOps and Automation",
                ...
                new TechEventOrganizerData {
                    ...
                    TargetAudience = "DevOps Engineers, Cloud Architects",
                    EventLevel = "Advanced",
                    EventTags = new Collection<string> { "Serverless", "Cloud Automation", "DevOps" }
                },
                new TechEventOrganizerData {
                    Id = 160,
                    Title = "Cloud DevOps and Automation",
                    ...
                    EventLevel = "Intermediate",
                    EventTags = new Collection<string> { "Monitoring", "Cloud Logging", "DevOps" }
                }
            };
            return employeeData;
        }
        public static Collection<TechEventOrganizerData> GetCloudSecurityEventData()
        {
            return new Collection<TechEventOrganizerData>
            {
                new TechEventOrganizerData {
                    Id=1,
...
                    EventLevel= "Intermediate",
                    EventTags = new Collection<string> { "Cloud Security", "Data Protection", "Network Security" }
                },
                new TechEventOrganizerData {
                    Id=2,
                    Title= "Cloud Security Essentials",
...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Encryption", "Cloud Privacy", "Data Protection" }
                },
                new TechEventOrganizerData {
                    Id=4,
                    Title= "Cloud Security Essentials",
...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "Cloud Threats", "Cloud Security", "Threat Detection" }    
                },
                new TechEventOrganizerData {
                    Id=5,
                    Title= "Cloud Security Essentials",
...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "Backup", "Disaster Recovery", "Cloud Security" }
                }
            };
        }
        public static Collection<TechEventOrganizerData> GetAIAutomationEventData()
        {
            return new Collection<TechEventOrganizerData>
            {
                new TechEventOrganizerData {
...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "AI", "Automation", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id=7,
                    Title= "AI for Automation",
...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "AI", "Process Optimization", "Automation" }
                },
                new TechEventOrganizerData {
                    Id=8,
                    Title= "AI for Automation",
...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "AI Automation", "Business Solutions", "Machine Learning" }
                },
                new TechEventOrganizerData {
                    Id=9,
                    Title= "AI for Automation",
...
                    EventLevel= "Advanced",
                    EventTags= new Collection<string> { "AI", "Predictive Maintenance", "Industrial Automation" }
                },
                new TechEventOrganizerData {
                    Id=10,
                    Title= "AI for Automation",
...
                    EventLevel= "Intermediate",
                    EventTags= new Collection<string> { "AI", "Chatbots", "Automation" }
                }
            };
        }
    }
