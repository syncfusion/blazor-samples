...
#pragma warning disable CS8618
        ...
        /// </summary>
        public SfDialog PrintDialog { get; set; }
        /// <summary>
        /// Indicates whether the print dialog is visible.
        /// </summary>
        private bool printDialogVisible;
        /// <summary>
...
#pragma warning restore CS8618
        ...
        private async Task PrintDialogHandler()
        {
            ...
            await Parent.PrintDiagram(options).ConfigureAwait(false);
            await PrintDialog.HideAsync().ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// </summary>
        public List<PaperListFields> PaperList { get; } = new List<PaperListFields>()
    {
        ...
        /// </summary>
        private string[] RegionValues = Enum.GetNames<Regions>();
        /// <summary>
