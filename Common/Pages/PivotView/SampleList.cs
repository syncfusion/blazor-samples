    ...
    internal partial class SampleConfig
    {
        public List<Sample> PivotTable { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                MetaDescription = "Discover the Blazor Pivot Table Classic Layout demo with a clean tabular view, sequential fields, and clear subtotals and totals to streamline data analysis.",
                HeaderText = "Blazor Pivot Table Example - Classic Layout",
                Type = SampleType.New,
                NotificationDescription = new string[]{ @"This sample demonstrates the classic Pivot Table layout, where row and column fields are arranged sequentially in a tabular format. Subtotals and grand totals are clearly displayed, making data comparison and analysis straightforward." }
            },
