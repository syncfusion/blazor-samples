...
namespace blazor_taskdetails
{
    public class TaskDetails
    {
        ...
        public static List<TaskDetails> GetAllTaskDetails()
        {
            ...
            {
                Datas.Add(new TaskDetails(10001, "Harder to work during power-saving mode", "High", "In Progress", "Tana", "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", new DateTime(2019, 06, 15), 505, "Shared by unsigned user", "Battery", "Flynn", "Need to Notify"));
