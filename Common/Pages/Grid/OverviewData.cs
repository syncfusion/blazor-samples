...
{   
    public class OverviewData
    {
        ...
        public static IReadOnlyList<OverviewData> GetAllRecords(int DataCount)
        {
        ...
        {
            System.ArgumentNullException.ThrowIfNull(mailList);
            ...
            string Mail = EmployeesName?.ToLower(System.Globalization.CultureInfo.CurrentCulture) + number + "@" + mailData;
            return Mail;
        }
