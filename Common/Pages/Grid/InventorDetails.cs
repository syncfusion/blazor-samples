...
namespace BlazorDemos.Pages.Grid.InventorDetailsNameSpace
{
    public class InventorDetails
    {
        ...
        public static IReadOnlyList<InventorDetails> GetAllRecords()
        {
            List<InventorDetails> inventor = new List<InventorDetails>();
            inventor.Add(new InventorDetails("1983-2014", "Poland", "Ĺukasz Kowalski", "Microcontrollers, Embedded systems", 1044, 580));
            inventor.Add(new InventorDetails("1977-2009", "Portugal", "João Pereira", "Hydraulic systems", 1123, 555));
            inventor.Add(new InventorDetails("1992-2016", "Czech Republic", "Štěpán Novák", "Nanotechnology", 1344, 542));
            inventor.Add(new InventorDetails("1995-2016", "Iceland", "Guðrún Jónsdóttir", "Biotechnology", 985, 520));
            inventor.Add(new InventorDetails("1988-2016", "Hungary", "Zsófia Tóth", "Genetic engineering", 923, 497));
            inventor.Add(new InventorDetails("1982-2013", "Brazil", "Márcio Silveira", "Agricultural machinery", 1132, 471));
            inventor.Add(new InventorDetails("1990-2016", "Mexico", "René González", "Civil engineering", 1211, 465));
            ...
            inventor.Add(new InventorDetails("1980-2015", "France", "Émile Durand", "Electric circuits, Telecommunication", 1450, 789));
            inventor.Add(new InventorDetails("1978-2016", "Spain", "José Martínez", "Solar energy, Photovoltaics", 1198, 712));
            inventor.Add(new InventorDetails("1990-2016", "Germany", "Jürgen Schäfer", "Semiconductor memory", 1324, 668));
            inventor.Add(new InventorDetails("1985-2015", "Sweden", "Åke Lindström", "Electronics, Signal processing", 998, 634));
            inventor.Add(new InventorDetails("1999-2016", "Norway", "Óyvind Håkonsen", "Mechanical engineering", 865, 610));
            ...
            inventor.Add(new InventorDetails("1907(b)-1997(d)", "Austria", "Béla Barényi", "Passive safety in automobiles", 1244, 595));
            ...
            inventor.Add(new InventorDetails("2000-2016", "Vietnam", "Ďặng Minh", "Electronic sensors", 1023, 443));
            inventor.Add(new InventorDetails("1991-2016", "Turkey", "Çağlar Yíldíz", "Data encryption", 1344, 420));
            inventor.Add(new InventorDetails("2003-2016", "Greece", "Αλέξανδρος Παπαδόπουλος", "Software engineering", 987, 399));
            return inventor;
        }
