    ...
    internal partial class SampleConfig
    {
        public List<Sample> DataGrid { get; set; } = new List<Sample>{
			...
			new Sample
            {
                ...
                Type = SampleType.New,
                NotificationDescription = new string[]{ @"Added the demo for lazy-load virtualization." },
            },
             new Sample
            {
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @"Updated the demo to focus the first cell of the grid content directly by using the shortcut keys." },
            },
            //new Sample
            //{
