    ...
    internal partial class SampleConfig
    {
        public List<Sample> DataGrid { get; set; } = new List<Sample>{
			...
			new Sample
            {
                ...
                NotificationDescription = new string []{@"Added the demo for sticky header while scrolling in the DataGrid component."},
                Type = SampleType.New
            },
            new Sample
            {
                ...
                NotificationDescription = new string[]{ @"Updated the demo for virtual scrolling with Inline Editing feature." },
            },
            new Sample
            {
