...
namespace blazor_griddata
{
    ...
    public class BugData
    {
        ...
        public static List<BugData> GetAllBugData()
        {
            ...
            {
                Datas.Add(new BugData(10001, "Harder to work during power-saving mode", "High", "In Progress", "Tana", "The app slows down significantly when the device enters power-saving mode.", new DateTime(2019, 06, 15), 505, "Shared by unsigned user", "Battery", "Flynn", "Need to Notify"));
