...
namespace SfBlazorHeatmapData
{
    internal static class HeatmapThemeHelper
    {
        internal static Theme GetCurrentHeatmapTheme(string navURL)
        {
            if (navURL.IndexOf("material", StringComparison.OrdinalIgnoreCase) > -1)
            {
            ...
            else if (navURL.IndexOf("tailwind3", StringComparison.OrdinalIgnoreCase) > -1)
            {
                if (navURL.IndexOf("dark", StringComparison.OrdinalIgnoreCase) > -1)
                {
    ...
    [SuppressMessage("Performance", "CA1814:Prefer jagged arrays over multidimensional arrays", Justification = "The sample data is intentionally stored as matrices for heat map demonstrations.")]
