...
{
    public sealed partial class AirlineTracker
    {
        [CascadingParameter]
        private MainLayout? Layout { get; set; }
        internal SfGantt<AirlineInfoModel> GanttInstance { get; set; } = new SfGantt<AirlineInfoModel>();
        internal List<AirlineInfoModel> AirlineInformations { get; set; } = new List<AirlineInfoModel>();
