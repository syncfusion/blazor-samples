...
namespace BlazorDemos.Pages.GanttChart
{
    ...
    {
        internal List<TimezoneData.TaskData>? TaskCollection { get; set; } = new List<TimezoneData.TaskData>();
        internal SfGantt<TimezoneData.TaskData>? GanttInstance { get; set; }
            ...
            ToolbarItems = new List<Object>()
            {
                ...
                new ItemModel
                {
                    ...
                    Template = (RenderFragment)(builder =>
                    {
                        ...
                        builder.AddAttribute(5, "aria-label", "Previous time span");
                        builder.CloseComponent();
                    }),
                ...
                new ItemModel
                {
                    ...
                    Template = (RenderFragment)(builder =>
                    {
                        ...
                        builder.AddAttribute(5, "aria-label", "Next time span");
                        builder.CloseComponent();
                    }),
                    Align = ItemAlign.Right
                },
        ...
        /// </summary>
        /// <param name="timeSpan">The toolbar action identifier.</param>
        public async Task ButtonClickHandler(string timeSpan)
        {
            if (timeSpan == "PreviousTimeSpan")
            {
                await JsInterop.InvokeVoidAsync("removeFocus", "previous-btn").ConfigureAwait(true);
                GanttInstance?.PreviousTimeSpan();
            }
            else if (timeSpan == "NextTimeSpan")
            {
                await JsInterop.InvokeVoidAsync("removeFocus", "next-btn").ConfigureAwait(true);
        ...
        /// </summary>
        /// <param name="args">The timezone dropdown change arguments.</param>
        private async Task OnTimeZoneChanged(Syncfusion.Blazor.DropDowns.ChangeEventArgs<string, TimeZoneFields> args)
        {
        ...
        /// </summary>
        /// <param name="args">The timeline mode dropdown change arguments.</param>
        ...
        /// </summary>
        private sealed class TimeZoneFields
        {
