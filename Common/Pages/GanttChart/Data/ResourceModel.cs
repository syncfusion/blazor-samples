...
namespace BlazorDemos.Pages.GanttChart.Data
{
    internal sealed class ResourceModel
    {
        ...
        /// <summary>
        /// A static list of predefined resources used in the Gantt chart.
        /// </summary>
        public static List<ResourceInfoModel> GetResources = new List<ResourceInfoModel>()
        {
            ...
            new ResourceInfoModel() { Id= 13, Name= "Electrical Engineer", MaxUnit = 80 },
            new ResourceInfoModel() { Id= 14, Name= "Mechanical Lead", MaxUnit = 90 },
            new ResourceInfoModel() { Id= 15, Name= "Architectural Consultant", MaxUnit = 75 },
            new ResourceInfoModel() { Id= 16, Name= "Site Inspector", MaxUnit = 60 }
        };

        public sealed class TaskInfoModel
        {
            public int Id { get; set; }
            public string Name { get; set; } = string.Empty;
        ...
        /// <summary>
        /// Returns a list of predefined tasks for the resource allocation sample.
        /// </summary>
        public static List<TaskInfoModel> GetTaskCollection()
        {
            return new List<TaskInfoModel>()
            {
                ...
                new TaskInfoModel() { Id = 10, Name = "Electrical layout design", StartDate = new DateTime(2021, 04, 02), Duration = "3", TaskType = "FixedWork", Work=40 },
                new TaskInfoModel() { Id = 11, Name = "HVAC system planning", StartDate = new DateTime(2021, 04, 03), Duration = "4", TaskType = "FixedWork", Work=48 },
                new TaskInfoModel() { Id = 12, Name = "Architectural drawing review", StartDate = new DateTime(2021, 04, 04), Duration = "2", TaskType = "FixedWork", Work=32 },
                new TaskInfoModel() { Id = 13, Name = "On-site inspection", StartDate = new DateTime(2021, 04, 05), Duration = "2", TaskType = "FixedWork", Work=24 },
            };
        }

        /// <summary>
        /// Returns a list of resource assignments for the resource allocation sample.
        /// </summary>
        public static List<AssignmentModel> GetAssignmentCollection()
        {
            List<AssignmentModel> assignments = new List<AssignmentModel>()
            {
                ...
                new AssignmentModel(){ PrimaryId=15, TaskId = 10 , ResourceId=13 },
                new AssignmentModel(){ PrimaryId=16, TaskId = 11 , ResourceId=14 },
                new AssignmentModel(){ PrimaryId=17, TaskId = 12 , ResourceId=15 },
                new AssignmentModel(){ PrimaryId=18, TaskId = 13 , ResourceId=16 },
            };
            return assignments;
        }
    }
