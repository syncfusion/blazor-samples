...
namespace BlazorDemos.Pages.GanttChart.Data
{
    internal sealed class OverviewData
    {
        ...
        internal sealed class ResourceInfoModel
        {
            public int Id { get; set; }
        ...
        internal static List<ResourceInfoModel> GetResources = new List<ResourceInfoModel>()
        {
        ...
        internal static List<TaskData> DataCollection()
        {
            ...
            { 
                ...
                new TaskData { Id = 5, ParentId = 2, Task = "Initiation meeting", StartDate = new DateTime(2025, 2, 11), EndDate = new DateTime(2025, 2, 18), Progress = 100, Department = "Project Management", Assignee = "John Smith", Priority = "High", Budget = 7000, ActualCost = 6000, Status = "Completed", Dependencies = "4", Risks = "Low", Notes = "All team members and key stakeholders attended", Category = "Meeting", Location = "Remote", TechStack = "N/A", EstimatedStoryPoints = 3, Initiative = "Team Building", PriorityLevel = "Alignment" },
        ...
        internal static List<AssignmentModel> GetAssignmentCollection()
        {
        ...
        internal static List<SegmentModel> GetSegmentCollection()
        {
        ...
        internal sealed class HolidayModel
        {
            public int Id { get; set; }
