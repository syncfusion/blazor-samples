...
{
    internal sealed class ObservableBindingData
    {
        /// <summary>
        /// Gets or sets the task name and triggers property change notification.
        /// </summary>
        internal sealed class TaskData : INotifyPropertyChanged
        {
        ...
        /// </summary>
        internal static ObservableCollection<TaskData> ProjectNewData()
        {
