    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> GanttChart { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                {
                    @"This sample demonstrates configurable PDF export in the Blazor Gantt Chart, with options to customize columns, timeline range, export type, scaling, orientation, and paper size."
                },
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
