    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> GanttChart { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                {
                    @"The sample has been updated to include timeline virtualization with CRUD operation support."
                }
            },
            new Sample
            {
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]
                {
                    @"The sample has been added to demonstrate state management in Gantt chart"
                },
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
