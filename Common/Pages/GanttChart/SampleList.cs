    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> GanttChart { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                {
                    @"The sample has been added which demonstrates binding large data with load on demand support"
                }
            },
            new Sample
            {
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]
                {
                    @"The sample has been updated by restricting the load time validation."
                }
            },
            new Sample
            {
            ...
            new Sample
            {
                ...
                NotificationDescription = new string[]
                {
                    @"The sample has been added to demonstrate clipboard functionality in Gantt Chart"
                },
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
