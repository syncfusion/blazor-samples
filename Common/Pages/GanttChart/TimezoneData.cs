...
namespace ej2_blazor_timezonedata
{
    public class TimezoneData
    {
        ...
        public static List<TaskData> GetTimezoneData()
        {
            List<TaskData> Tasks = new List<TaskData>
            {
                ...
                new TaskData { TaskId = 2, TaskName = "Stakeholder alignment meeting", StartDate = new DateTime(2025, 10, 10, 9, 0, 0), EndDate = new DateTime(2025, 10, 10, 10, 30, 0), ParentId = 1, Duration = "1.5", Progress = 100 },
