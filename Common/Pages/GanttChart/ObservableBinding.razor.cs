...
{
    public sealed partial class ObservableBinding
    {
        internal SfGantt<ObservableBindingData.TaskData>? GanttInstance { get; set; }
        internal ObservableCollection<ObservableBindingData.TaskData> ObservableData { get; set; } = new ObservableCollection<ObservableBindingData.TaskData>();
        ...
        /// </summary>
        private async Task RowUpdated(RowUpdatedEventArgs<ObservableBindingData.TaskData> args)
        {
