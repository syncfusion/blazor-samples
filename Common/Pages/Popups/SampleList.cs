    ...
    internal partial class SampleConfig
    {
        public List<Sample> Dialog { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                Directory = "Popups/Dialog",
                Url = "dialog/predefine-dialogs",
                FileName = "PredefineDialogs.razor",
                NotificationDescription = new string[]{ @"Updated the demo for predefined dialogs where dialogs are rendered and shown using utility methods." }
            },
            new Sample
            {
                Name = "Modal",
