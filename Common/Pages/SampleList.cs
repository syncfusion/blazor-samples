namespace BlazorDemos
{
    internal partial class SampleConfig
    {
        internal SampleConfig()
        {
            ...
            SampleBrowser.SampleList.Add(new SampleList
            {
                Name = "Smart Rich Text Editor",
                Category = "Smart Components",
                Directory = "AISamples",
                Samples = AISmartRichTextEditor,
                ControllerName = "AISmartRichTextEditor",
                DemoPath = "ai-smart-rich-text-editor/overview",
                ComponentIconName = "richtexteditor"
            });
            SampleBrowser.SampleList.Add(new SampleList
            {
            ...
            SampleBrowser.SampleList.Add(new SampleList
            {
                ...
                Type = SampleType.None,
                Samples = ChartWizard,
                ControllerName = "ChartWizard",
                DemoPath = "chart-wizard/default-functionalities"
            });
            SampleBrowser.SampleList.Add(new SampleList
            {
            ...
            SampleBrowser.SampleList.Add(new SampleList
            {
                ...
                Category = "Interactive Chat",
                Directory = "InteractiveChat/InlineAIAssist",
                Type = SampleType.Preview,
                Samples = InlineAIAssist,
                ControllerName = "InlineAIAssist",
                DemoPath = "inline-ai-assist/overview",
                IsPreview = true
            });
#endif
            SampleBrowser.SampleList.Add(new SampleList
