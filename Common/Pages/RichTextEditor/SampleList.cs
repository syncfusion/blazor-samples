    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> RichTextEditor { get; set; } = new List<Sample>{
             ...
             new Sample
            {
                ...
                NotificationDescription = new string[]{@"The Blazor Rich Text Editor now includes support for pasting single and multiple images, audio files, and video files directly into the editor."},
