    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> ColorPicker { get; set; } = new List<Sample>
        {
            ...
            new Sample
            {
                ...
                Url = "color-picker/inline",
                FileName = "Inline.razor",
                MetaTitle = "Blazor Color Palettes Example | Inline Mode | Syncfusion",
                HeaderText = "Blazor Color Palttes - Inline Mode",
                MetaDescription = "Blazor Color Palttes inline mode demo shows embedding color selection interface directly into page layout without a popup, allowing access to all color options."
            }
        };
