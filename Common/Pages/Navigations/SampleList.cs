    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> Toolbar { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                {
                     @"Added a demo to showcase template customization possibilities of Toolbar."
                }
            },
            new Sample
            {
        ...
        public List<Sample> Carousel { get; set; } = new List<Sample>{
            new Sample
            {
                ...
                NotificationDescription = new string[]
                {
                     @"Introduced the Carousel component in Blazor which shows a collection of items one at a time like a slideshow."
                }
            },
            new Sample
            {
                ...
                MappingSampleName = "With Templates",
                 NotificationDescription = new string[]
                {
                     @"Added a demo to showcase the customized rendering of items, navigation buttons, indicators as templates."
                }
            },
            new Sample
            {
                ...
                MappingSampleName = "With Data Binding",
                 NotificationDescription = new string[]
                {
                     @"Added a demo to showcase the loop rendering Carousel item."
                }
            },
            new Sample
            {
                ...
                MappingSampleName = "With Keyboard Interactions",
                 NotificationDescription = new string[]
                {
                     @"Added a demo to showcase the keyboard navigation support in the Carousel component."
                }
            },
            new Sample
            {
                ...
                MappingSampleName = "With partial visible",
                 NotificationDescription = new string[]
                {
                     @"Added a demo to showcase the partial visible support in the Carousel component."
                }
            },
            new Sample
            {
                ...
                MappingSampleName = "With API",
                 NotificationDescription = new string[]
                {
                     @"Added a demo to showcase the properties available in Carousel Component such as Loop, ShowPlayButton, Interval, ShowIndicators, ButtonsVisibility and AutoPlay."
                }
            }
        };
