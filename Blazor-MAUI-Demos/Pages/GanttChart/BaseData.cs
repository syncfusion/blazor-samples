    ...
    public class BaseData
    {
        ...
        public static List<TaskData> GetTaskCollection()
        {
            ...
            new TaskData() {
                ...
                BaselineEndDate= new DateTime(2021, 04, 04),
            ...
            new TaskData() {
                ...
                Progress = 40,
                BaselineStartDate= new DateTime(2021, 04, 02),
                BaselineEndDate= new DateTime(2021, 04, 06),
                ParentId = 1
            },
            new TaskData() {
                TaskId = 4,
                ...
                BaselineStartDate= new DateTime(2021, 04, 08),
                BaselineEndDate= new DateTime(2021, 04, 08),
                Progress = 30,
                ParentId = 1
            },
              new TaskData() {
            ...
            new TaskData() {
                ...
                ParentId = 5,
                BaselineStartDate= new DateTime(2021, 04, 02),
                BaselineEndDate= new DateTime(2021, 04, 03)
