...
namespace Blazor_MAUI_Demos.Pages.GanttChart
{
    public class EventData
    {
        ...
        new TaskData() {
            ...
            EndDate = new DateTime(2021, 04, 22),
            Duration = "0",
            Progress = 30,
            ParentId = 6,
            Predecessor="10",
        ...
        new TaskData() {
            TaskId = 19,
            TaskName = "Define manufacturing cost",
            StartDate = new DateTime(2021, 04, 26),
            EndDate = new DateTime(2021, 04, 29),
            Duration = "2",
            Progress = 40,
        ...
        new TaskData() {
            TaskId = 23,
            TaskName = "Develop designs to meet industry standard",
         ...
         new GanttIndicator()
        {
            ...
            IconClass="e-btn-icon e-notes-info e-icons e-icon-left e-gantt e-notes-info::after",
            Date=new DateTime(2021, 05, 26),
            Tooltip= "Production phase"
