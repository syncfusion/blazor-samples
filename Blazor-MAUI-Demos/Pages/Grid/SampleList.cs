...
namespace Blazor_MAUI_Demos
{
    internal partial class SampleConfig
    {
        public List<Sample> DataGrid { get; set; } = new List<Sample>{
            ...
            //    NotificationDescription = new string[]{ @"The ExpandoObject binding demo was updated to include different numeric columntypes for the Type property. This demo showcases how to set the columntype based on its value type." }
            //},
            //new Sample
            //{
            ...
            //    Type = SampleType.Updated,
            //    NotificationDescription = new string[]{ @"The DynamicObject binding demo was updated to include different numeric columntypes for the Type property. This demo showcases how to set the columntype based on its value type." }
            //},
            new Sample
            {
