...
namespace blazor_griddata
{
    ...
    public class OrderData {
        ...
        public static List<OrderData> GetAllRecords()
        {
            ...
            for (int i = 1; i < 850; i++)
            {
                order.Add(new OrderData(code + i, customerID[new Random().Next(89)], Math.Round((2.3 * i), 2), DateTime.Now.AddDays(-i), shipCountry[new Random().Next(21)], i%2 == 0));
            }
            return order;
        }
        public int? OrderID { get; set; }
    ...
    public class OrdersDetails
    {
        ...
        public static List<OrdersDetails> GetAllRecords()
        {
            ...
            for (int i = 1; i <= 15; i++)
            {
                order.Add(new OrdersDetails(code + 1, "ALFKI", i + 0, Math.Round((2.3 * i), 2), false, new DateTime(1991, 05, 15), "Berlin", "Simons bistro", "Denmark", new DateTime(1996, 7, 16), "Kirchgasse 6"));
                order.Add(new OrdersDetails(code + 2, "ANATR", i + 2, Math.Round((3.3 * i), 2), true, new DateTime(1990, 04, 04), "Madrid", "Queen Cozinha", "Brazil", new DateTime(1996, 9, 11), "Avda. Azteca 123"));
                order.Add(new OrdersDetails(code + 3, "ANTON", i + 1, Math.Round((4.3 * i), 2), false, new DateTime(1957, 11, 30), "Cholchester", "Frankenversand", "Germany", new DateTime(1996, 10, 7), "Carrera 52 con Ave. Bolívar #65-98 Llano Largo"));
                order.Add(new OrdersDetails(code + 4, "BLONP", i + 3, Math.Round((5.3 * i), 2), true, new DateTime(1930, 10, 22), "Marseille", "Ernst Handel", "Austria", new DateTime(1996, 12, 30), "Magazinweg 7"));
                order.Add(new OrdersDetails(code + 5, "BOLID", i + 4, Math.Round((6.3 * i), 2), false, new DateTime(1953, 02, 18), "Tsawassen", "Hanari Carnes", "Switzerland", new DateTime(1997, 12, 3), "1029 - 12th Ave. S."));
                code += 5;
            }
            return order;
        }
