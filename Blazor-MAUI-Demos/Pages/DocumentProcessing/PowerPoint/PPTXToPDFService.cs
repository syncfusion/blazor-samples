...
namespace Blazor_MAUI_Demos.Pages.DocumentProcessing.PowerPoint
{
    public class PPTXToPDFService
    {
        ...
        public PPTXToPDFService(Dictionary<string, MemoryStream> fileData)
        {
        ...
        public MemoryStream PDFInput()
        {
            ...
            //Save the document as a stream and return the stream
            MemoryStream stream = new MemoryStream();//Save the created PowerPoint document to MemoryStream
