    ...
    internal partial class SampleConfig
    {
        ...
        public List<Sample> DocIO { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                Type = SampleType.Updated,
                MetaDescription = "DocIO supports to encrypt a Word document with document protection.",
                SourceFiles = new List<SourceCollection>()
                {
                    new SourceCollection
                    {
		  ...
		  new Sample
                 ...
                 new Sample
            {
               ...
               new Sample
               {
                ...
                Category="Security",
                Directory="DocumentProcessing/PDF",
                MetaDescription="This sample demonstrates how to encrypt a PDF document.",
                Url="pdf/encryption",
                Type=SampleType.Updated,
                SourceFiles=new List<SourceCollection>()
                {
        ...
        public List<Sample> XlsIO { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                MetaDescription = "This sample demonstrates how to use the Auto Fill and Fill Series options with XlsIO.",
                Type=SampleType.New,
                NotificationDescription = new string[]
                {
