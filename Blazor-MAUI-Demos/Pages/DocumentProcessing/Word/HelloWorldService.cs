...
namespace Blazor_MAUI_Demos.Pages.DocumentProcessing.Word
{
    public class HelloWorldService
    {
        ...
        public MemoryStream CreateWordDocument(string documentType)
        {
            ...
            Assembly assembly = typeof(HelloWorldService).GetTypeInfo().Assembly;
            string resourcePath = "Blazor_MAUI_Demos.wwwroot.images.word.adventure-cycle.png";
            Stream fileStream = assembly.GetManifestResourceStream(resourcePath);
            //Appends picture to the paragraph
            WPicture picture = paragraph.AppendPicture(fileStream) as WPicture;
            ...
            paragraph.BreakCharacterFormat.FontSize = 12f;
            //Appends picture to the paragraph
            resourcePath = "Blazor_MAUI_Demos.wwwroot.images.word.mountain-200.png";
            fileStream = assembly.GetManifestResourceStream(resourcePath);
            picture = paragraph.AppendPicture(fileStream) as WPicture;
            ...
            paragraph.ApplyStyle("Heading 1");
            paragraph.ParagraphFormat.LineSpacing = 12f;
            resourcePath = "Blazor_MAUI_Demos.wwwroot.images.word.mountain-300.png";
            fileStream = assembly.GetManifestResourceStream(resourcePath);
            //Appends picture to the paragraph
            picture = paragraph.AppendPicture(fileStream) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
            ...
            paragraph.ApplyStyle("Heading 1");
            paragraph.ParagraphFormat.LineSpacing = 12f;
            resourcePath = "Blazor_MAUI_Demos.wwwroot.images.word.road-550-w.png";
            fileStream = assembly.GetManifestResourceStream(resourcePath);
            //Appends picture to the paragraph
            picture = paragraph.AppendPicture(fileStream) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
