...
if %errorlevel% equ 0 (
    echo.
    echo FileManager category filter applied successfully!
    echo Included components: FileManager
    exit /b 0
) else (
